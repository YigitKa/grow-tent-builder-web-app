...
Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let f=Vt(),p;if(t){let e=typeof t==`string`?Ye(t):t;k(u===`/`||e.pathname?.startsWith(u),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${u}" but pathname "${e.pathname}" was given in the \`location\` prop.`),p=e}else p=f;let m=p.pathname||`/`,h=m;if(u!==`/`){let e=u.replace(/^\//,``).split(`/`);h=`/`+m.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let g=Qe(e,{pathname:h});A(d||g!=null,`No routes matched location "${p.pathname}${p.search}${p.hash}" `),A(g==null||g[g.length-1].route.element!==void 0||g[g.length-1].route.Component!==void 0||g[g.length-1].route.lazy!==void 0,`Matched leaf route at location "${p.pathname}${p.search}${p.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let _=$t(g&&g.map(e=>Object.assign({},e,{params:Object.assign({},c,e.params),pathname:Tt([u,a.encodeLocation?a.encodeLocation(e.pathname.replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?u:Tt([u,a.encodeLocation?a.encodeLocation(e.pathnameBase.replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),o,n,r,i);return t&&_?b.createElement(It.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,...p},navigationType:`POP`}},_):_}function M(){let e=ln(),t=kt(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=b.createElement(b.Fragment,null,b.createElement(`p`,null,`💿 Hey developer 👋`),b.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,b.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,b.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),b.createElement(b.Fragment,null,b.createElement(`h2`,null,`Unexpected Application Error!`),b.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?b.createElement(`pre`,{style:i},n):null,o)}var Xt=b.createElement(M,null),Zt=class extends b.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){return this.state.error===void 0?this.props.children:b.createElement(Lt.Provider,{value:this.props.routeContext},b.createElement(Rt.Provider,{value:this.state.error,children:this.props.component}))}};function Qt({routeContext:e,match:t,children:n}){let r=b.useContext(At);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),b.createElement(Lt.Provider,{value:e},n)}function $t(e,t=[],n=null,r=null,i=null){if(e==null){if(!n)return null;if(n.errors)e=n.matches;else if(t.length===0&&!n.initialized&&n.matches.length>0)e=n.matches;else return null}let a=e,o=n?.errors;if(o!=null){let e=a.findIndex(e=>e.route.id&&o?.[e.route.id]!==void 0);k(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(o).join(`,`)}`),a=a.slice(0,Math.min(a.length,e+1))}let s=!1,c=-1;if(n)for(let e=0;e<a.length;e++){let t=a[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(c=e),t.route.id){let{loaderData:e,errors:r}=n,i=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!r||r[t.route.id]===void 0);if(t.route.lazy||i){s=!0,a=c>=0?a.slice(0,c+1):[a[0]];break}}}let l=n&&r?(e,t)=>{r(e,{location:n.location,params:n.matches?.[0]?.params??{},errorInfo:t})}:void 0;return a.reduceRight((e,r,i)=>{let u,d=!1,f=null,p=null;n&&(u=o&&r.route.id?o[r.route.id]:void 0,f=r.route.errorElement||Xt,s&&(c<0&&i===0?(fn(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),d=!0,p=null):c===i&&(d=!0,p=r.route.hydrateFallbackElement||null)));let m=t.concat(a.slice(0,i+1)),h=()=>{let t;return t=u?f:d?p:r.route.Component?b.createElement(r.route.Component,null):r.route.element?r.route.element:e,b.createElement(Qt,{match:r,routeContext:{outlet:e,matches:m,isDataRoute:n!=null},children:t})};return n&&(r.route.ErrorBoundary||r.route.errorElement||i===0)?b.createElement(Zt,{location:n.location,revalidation:n.revalidation,component:f,error:u,children:h(),routeContext:{outlet:null,matches:m,isDataRoute:!0},onError:l}):h()},null)}function en(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function tn(e){let t=b.useContext(At);return k(t,en(e)),t}function nn(e){let t=b.useContext(jt);return k(t,en(e)),t}function rn(e){let t=b.useContext(Lt);return k(t,en(e)),t}function an(e){let t=rn(e),n=t.matches[t.matches.length-1];return k(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function on(){return an(`useRouteId`)}function sn(){return nn(`useNavigation`).navigation}function cn(){let{matches:e,loaderData:t}=nn(`useMatches`);return b.useMemo(()=>e.map(e=>et(e,t)),[e,t])}function ln(){let e=b.useContext(Rt),t=nn(`useRouteError`),n=an(`useRouteError`);return e===void 0?t.errors?.[n]:e}function un(){let{router:e}=tn(`useNavigate`),t=an(`useNavigate`),n=b.useRef(!1);return Ut(()=>{n.current=!0}),b.useCallback(async(r,i={})=>{A(n.current,Ht),n.current&&(typeof r==`number`?e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var dn={};function fn(e,t,n){!t&&!dn[e]&&(dn[e]=!0,A(!1,n))}b.memo(pn);function pn({routes:e,future:t,state:n,unstable_onError:r}){return Yt(e,void 0,n,r,t)}function mn(e){k(!1,`A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.`)}function hn({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1}){k(!Bt(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let o=e.replace(/^\/*/,`/`),s=b.useMemo(()=>({basename:o,navigator:i,static:a,future:{}}),[o,i,a]);typeof n==`string`&&(n=Ye(n));let{pathname:c=`/`,search:l=``,hash:u=``,state:d=null,key:f=`default`}=n,p=b.useMemo(()=>{let e=_t(c,o);return e==null?null:{location:{pathname:e,search:l,hash:u,state:d,key:f},navigationType:r}},[o,c,l,u,d,f,r]);return A(p!=null,`<Router basename="${o}"> is not able to match the URL "${c}${l}${u}" because it does not start with the basename, so the <Router> won't render anything.`),p==null?null:b.createElement(Ft.Provider,{value:s},b.createElement(It.Provider,{children:t,value:p}))}function gn({children:e,location:t}){return Jt(_n(e),t)}function _n(e,t=[]){let n=[];return b.Children.forEach(e,(e,r)=>{if(!b.isValidElement(e))return;let i=[...t,r];if(e.type===b.Fragment){n.push.apply(n,_n(e.props.children,i));return}k(e.type===mn,`[${typeof e.type==`string`?e.type:e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),k(!e.props.index||!e.props.children,`An index route cannot have child routes.`);let a={id:e.props.id||i.join(`-`),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,middleware:e.props.middleware,loader:e.props.loader,action:e.props.action,hydrateFallbackElement:e.props.hydrateFallbackElement,HydrateFallback:e.props.HydrateFallback,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:e.props.hasErrorBoundary===!0||e.props.ErrorBoundary!=null||e.props.errorElement!=null,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(a.children=_n(e.props.children,i)),n.push(a)}),n}var vn=`get`,yn=`application/x-www-form-urlencoded`;function bn(e){return e!=null&&typeof e.tagName==`string`}function xn(e){return bn(e)&&e.tagName.toLowerCase()===`button`}function Sn(e){return bn(e)&&e.tagName.toLowerCase()===`form`}function Cn(e){return bn(e)&&e.tagName.toLowerCase()===`input`}function wn(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function Tn(e,t){return e.button===0&&(!t||t===`_self`)&&!wn(e)}var En=null;function Dn(){if(En===null)try{new FormData(document.createElement(`form`),0),En=!1}catch{En=!0}return En}var On=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function kn(e){return e!=null&&!On.has(e)?(A(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${yn}"`),null):e}function An(e,t){let n,r,i,a,o;if(Sn(e)){let o=e.getAttribute(`action`);r=o?_t(o,t):null,n=e.getAttribute(`method`)||vn,i=kn(e.getAttribute(`enctype`))||yn,a=new FormData(e)}else if(xn(e)||Cn(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?_t(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||vn,i=kn(e.getAttribute(`formenctype`))||kn(o.getAttribute(`enctype`))||yn,a=new FormData(o,e),!Dn()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if(bn(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=vn,r=null,i=yn,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);function jn(e,t){if(e===!1||e==null)throw Error(t)}function Mn(e,t,n){let r=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return r.pathname===`/`?r.pathname=`_root.${n}`:t&&_t(r.pathname,t)===`/`?r.pathname=`${t.replace(/\/$/,``)}/_root.${n}`:r.pathname=`${r.pathname.replace(/\/$/,``)}.${n}`,r}async function Nn(e,t){if(e.id in t)return t[e.id];try{let n=await He(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Pn(e){return e!=null&&typeof e.page==`string`}function Fn(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function In(e,t,n){return Vn((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await Nn(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(Fn).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function Ln(e,t,n,r,i,a){let o=(e,t)=>n[t]?e.route.id!==n[t].route.id:!0,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function Rn(e,t,{includeHydrateFallback:n}={}){return zn(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function zn(e){return[...new Set(e)]}function Bn(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function Vn(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!Pn(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(Bn(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function Hn(){let e=b.useContext(At);return jn(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function Un(){let e=b.useContext(jt);return jn(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var Wn=b.createContext(void 0);Wn.displayName=`FrameworkContext`;function Gn(){let e=b.useContext(Wn);return jn(e,`You must render this element inside a <HydratedRouter> element`),e}function Kn(e,t){let n=b.useContext(Wn),[r,i]=b.useState(!1),[a,o]=b.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:l,onMouseLeave:u,onTouchStart:d}=t,f=b.useRef(null);b.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return f.current&&e.observe(f.current),()=>{e.disconnect()}}},[e]),b.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let p=()=>{i(!0)},m=()=>{i(!1),o(!1)};return n?e===`intent`?[a,f,{onFocus:qn(s,p),onBlur:qn(c,m),onMouseEnter:qn(l,p),onMouseLeave:qn(u,m),onTouchStart:qn(d,p)}]:[a,f,{}]:[!1,f,{}]}function qn(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function Jn({page:e,...t}){let{router:n}=Hn(),r=b.useMemo(()=>Qe(n.routes,e,n.basename),[n.routes,e,n.basename]);return r?b.createElement(Xn,{page:e,matches:r,...t}):null}function Yn(e){let{manifest:t,routeModules:n}=Gn(),[r,i]=b.useState([]);return b.useEffect(()=>{let r=!1;return In(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function Xn({page:e,matches:t,...n}){let r=Vt(),{manifest:i,routeModules:a}=Gn(),{basename:o}=Hn(),{loaderData:s,matches:c}=Un(),l=b.useMemo(()=>Ln(e,t,c,i,r,`data`),[e,t,c,i,r]),u=b.useMemo(()=>Ln(e,t,c,i,r,`assets`),[e,t,c,i,r]),d=b.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,c=!1;if(t.forEach(e=>{let t=i.routes[e.route.id];!t||!t.hasLoader||(!l.some(t=>t.route.id===e.route.id)&&e.route.id in s&&a[e.route.id]?.shouldRevalidate||t.hasClientLoader?c=!0:n.add(e.route.id))}),n.size===0)return[];let u=Mn(e,o,`data`);return c&&n.size>0&&u.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[u.pathname+u.search]},[o,s,r,i,l,t,e,a]),f=b.useMemo(()=>Rn(u,i),[u,i]),p=Yn(u);return b.createElement(b.Fragment,null,d.map(e=>b.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),f.map(e=>b.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),p.map(({key:e,link:t})=>b.createElement(`link`,{key:e,nonce:n.nonce,...t})))}function Zn(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}var Qn=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{Qn&&(window.__reactRouterVersion=`7.9.6`)}catch{}function $n({basename:e,children:t,window:n}){let r=b.useRef();r.current??=We({window:n,v5Compat:!0});let i=r.current,[a,o]=b.useState({action:i.action,location:i.location}),s=b.useCallback(e=>{b.startTransition(()=>o(e))},[o]);return b.useLayoutEffect(()=>i.listen(s),[i,s]),b.createElement(hn,{basename:e,children:t,location:a.location,navigationType:a.action,navigator:i})}function er({basename:e,children:t,history:n}){let[r,i]=b.useState({action:n.action,location:n.location}),a=b.useCallback(e=>{b.startTransition(()=>i(e))},[i]);return b.useLayoutEffect(()=>n.listen(a),[n,a]),b.createElement(hn,{basename:e,children:t,location:r.location,navigationType:r.action,navigator:n})}er.displayName=`unstable_HistoryRouter`;var tr=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,N=b.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,state:o,target:s,to:c,preventScrollReset:l,viewTransition:u,...d},f){let{basename:p}=b.useContext(Ft),m=typeof c==`string`&&tr.test(c),h,g=!1;if(typeof c==`string`&&m&&(h=c,Qn))try{let e=new URL(window.location.href),t=c.startsWith(`//`)?new URL(e.protocol+c):new URL(c),n=_t(t.pathname,p);t.origin===e.origin&&n!=null?c=n+t.search+t.hash:g=!0}catch{A(!1,`<Link to="${c}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let _=zt(c,{relative:r}),[v,y,x]=Kn(n,d),S=cr(c,{replace:a,state:o,target:s,preventScrollReset:l,relative:r,viewTransition:u});function C(t){e&&e(t),t.defaultPrevented||S(t)}let w=b.createElement(`a`,{...d,...x,href:h||_,onClick:g||i?e:C,ref:Zn(f,y),target:s,"data-discover":!m&&t===`render`?`true`:void 0});return v&&!m?b.createElement(b.Fragment,null,w,b.createElement(Jn,{page:_})):w});N.displayName=`Link`;var nr=b.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},l){let u=qt(a,{relative:c.relative}),d=Vt(),f=b.useContext(jt),{navigator:p,basename:m}=b.useContext(Ft),h=f!=null&&vr(u)&&o===!0,g=p.encodeLocation?p.encodeLocation(u).pathname:u.pathname,_=d.pathname,v=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;t||(_=_.toLowerCase(),v=v?v.toLowerCase():null,g=g.toLowerCase()),v&&m&&(v=_t(v,m)||v);let y=g!==`/`&&g.endsWith(`/`)?g.length-1:g.length,x=_===g||!r&&_.startsWith(g)&&_.charAt(y)===`/`,S=v!=null&&(v===g||!r&&v.startsWith(g)&&v.charAt(g.length)===`/`),C={isActive:x,isPending:S,isTransitioning:h},w=x?e:void 0,ee;ee=typeof n==`function`?n(C):[n,x?`active`:null,S?`pending`:null,h?`transitioning`:null].filter(Boolean).join(` `);let te=typeof i==`function`?i(C):i;return b.createElement(N,{...c,"aria-current":w,className:ee,ref:l,style:te,to:a,viewTransition:o},typeof s==`function`?s(C):s)});nr.displayName=`NavLink`;var rr=b.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=vn,action:s,onSubmit:c,relative:l,preventScrollReset:u,viewTransition:d,...f},p)=>{let m=dr(),h=fr(s,{relative:l}),g=o.toLowerCase()===`get`?`get`:`post`,_=typeof s==`string`&&tr.test(s);return b.createElement(`form`,{ref:p,method:g,action:h,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o;m(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:l,preventScrollReset:u,viewTransition:d})},...f,"data-discover":!_&&e===`render`?`true`:void 0})});rr.displayName=`Form`;function ir({getKey:e,storageKey:t,...n}){let r=b.useContext(Wn),{basename:i}=b.useContext(Ft),a=Vt(),o=cn();gr({getKey:e,storageKey:t});let s=b.useMemo(()=>{if(!r||!e)return null;let t=hr(a,o,i,e);return t===a.key?null:t},[]);if(!r||r.isSpaMode)return null;let c=((e,t)=>{if(!window.history.state||!window.history.state.key){let e=Math.random().toString(32).slice(2);window.history.replaceState({key:e},``)}try{let n=JSON.parse(sessionStorage.getItem(e)||`{}`)[t||window.history.state.key];typeof n==`number`&&window.scrollTo(0,n)}catch(t){console.error(t),sessionStorage.removeItem(e)}}).toString();return b.createElement(`script`,{...n,suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${c})(${JSON.stringify(t||pr)}, ${JSON.stringify(s)})`}})}ir.displayName=`ScrollRestoration`;function ar(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function or(e){let t=b.useContext(At);return k(t,ar(e)),t}function sr(e){let t=b.useContext(jt);return k(t,ar(e)),t}function cr(e,{target:t,replace:n,state:r,preventScrollReset:i,relative:a,viewTransition:o}={}){let s=Wt(),c=Vt(),l=qt(e,{relative:a});return b.useCallback(u=>{Tn(u,t)&&(u.preventDefault(),s(e,{replace:n===void 0?Je(c)===Je(l):n,state:r,preventScrollReset:i,relative:a,viewTransition:o}))},[c,s,l,n,r,t,e,i,a,o])}var lr=0,ur=()=>`__${String(++lr)}__`;function dr(){let{router:e}=or(`useSubmit`),{basename:t}=b.useContext(Ft),n=on();return b.useCallback(async(r,i={})=>{let{action:a,method:o,encType:s,formData:c,body:l}=An(r,t);if(i.navigate===!1){let t=i.fetcherKey||ur();await e.fetch(t,n,i.action||a,{preventScrollReset:i.preventScrollReset,formData:c,body:l,formMethod:i.method||o,formEncType:i.encType||s,flushSync:i.flushSync})}else await e.navigate(i.action||a,{preventScrollReset:i.preventScrollReset,formData:c,body:l,formMethod:i.method||o,formEncType:i.encType||s,replace:i.replace,state:i.state,fromRouteId:n,flushSync:i.flushSync,viewTransition:i.viewTransition})},[e,t,n])}function fr(e,{relative:t}={}){let{basename:n}=b.useContext(Ft),r=b.useContext(Lt);k(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...qt(e||`.`,{relative:t})},o=Vt();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:Tt([n,a.pathname])),Je(a)}var pr=`react-router-scroll-positions`,mr={};function hr(e,t,n,r){let i=null;return r&&(i=r(n===`/`?e:{...e,pathname:_t(e.pathname,n)||e.pathname},t)),i??=e.key,i}function gr({getKey:e,storageKey:t}={}){let{router:n}=or(`useScrollRestoration`),{restoreScrollPosition:r,preventScrollReset:i}=sr(`useScrollRestoration`),{basename:a}=b.useContext(Ft),o=Vt(),s=cn(),c=sn();b.useEffect(()=>(window.history.scrollRestoration=`manual`,()=>{window.history.scrollRestoration=`auto`}),[]),_r(b.useCallback(()=>{if(c.state===`idle`){let t=hr(o,s,a,e);mr[t]=window.scrollY}try{sessionStorage.setItem(t||pr,JSON.stringify(mr))}catch(e){A(!1,`Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (${e}).`)}window.history.scrollRestoration=`auto`},[c.state,e,a,o,s,t])),typeof document<`u`&&(b.useLayoutEffect(()=>{try{let e=sessionStorage.getItem(t||pr);e&&(mr=JSON.parse(e))}catch{}},[t]),b.useLayoutEffect(()=>{let t=n?.enableScrollRestoration(mr,()=>window.scrollY,e?(t,n)=>hr(t,n,a,e):void 0);return()=>t&&t()},[n,a,e]),b.useLayoutEffect(()=>{if(r!==!1){if(typeof r==`number`){window.scrollTo(0,r);return}try{if(o.hash){let e=document.getElementById(decodeURIComponent(o.hash.slice(1)));if(e){e.scrollIntoView();return}}}catch{A(!1,`"${o.hash.slice(1)}" is not a decodable element ID. The view will not scroll to it.`)}i!==!0&&window.scrollTo(0,0)}},[o,r,i]))}function _r(e,t){let{capture:n}=t||{};b.useEffect(()=>{let t=n==null?void 0:{capture:n};return window.addEventListener(`pagehide`,e,t),()=>{window.removeEventListener(`pagehide`,e,t)}},[e,n])}function vr(e,{relative:t}={}){let n=b.useContext(Mt);k(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=or(`useViewTransitionState`),i=qt(e,{relative:t});if(!n.isTransitioning)return!1;let a=_t(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=_t(n.nextLocation.pathname,r)||n.nextLocation.pathname;return mt(i.pathname,o)!=null||mt(i.pathname,a)!=null}var yr=o((e=>{var t=u(),n=Symbol.for(`react.element`),r=Symbol.for(`react.fragment`),i=Object.prototype.hasOwnProperty,a=t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,o={key:!0,ref:!0,__self:!0,__source:!0};function s(e,t,r){var s,c={},l=null,u=null;for(s in r!==void 0&&(l=``+r),t.key!==void 0&&(l=``+t.key),t.ref!==void 0&&(u=t.ref),t)i.call(t,s)&&!o.hasOwnProperty(s)&&(c[s]=t[s]);if(e&&e.defaultProps)for(s in t=e.defaultProps,t)c[s]===void 0&&(c[s]=t[s]);return{$$typeof:n,type:e,key:l,ref:u,props:c,_owner:a.current}}e.Fragment=r,e.jsx=s,e.jsxs=s})),P=c(o(((e,t)=>{t.exports=yr()}))(),1);const br=(0,b.createContext)();var xr={currentStep:1,tentSize:{width:4,depth:4,height:7,unit:`ft`},mediaType:null,selectedItems:{lighting:[],ventilation:[],environment:[],nutrients:[],monitoring:[]},totals:{cost:0,power:0,cfmRequired:0}};function Sr(e){let t=0,n=0;Object.values(e.selectedItems).flat().forEach(e=>{let r=e.quantity||1;t+=(e.price||0)*r,n+=(e.watts||0)*r});let{width:r,depth:i,height:a}=e.tentSize,o=r*i*a,s=Math.ceil(o*1.2);return{cost:t,power:n,cfmRequired:s}}function Cr(e,t){switch(t.type){case`NEXT_STEP`:return{...e,currentStep:Math.min(e.currentStep+1,8)};case`PREV_STEP`:return{...e,currentStep:Math.max(e.currentStep-1,1)};case`SET_STEP`:return{...e,currentStep:t.payload};case`SET_TENT_SIZE`:{let n={...e,tentSize:t.payload};return{...n,totals:Sr(n)}}case`SET_MEDIA_TYPE`:return{...e,mediaType:t.payload,selectedItems:{...e.selectedItems,nutrients:[]}};case`ADD_ITEM`:{let{category:n,item:r}=t.payload,i=e.selectedItems[n].find(e=>e.id===r.id),a;a=i?{...e.selectedItems,[n]:e.selectedItems[n].map(e=>e.id===r.id?{...e,quantity:(e.quantity||1)+1}:e)}:{...e.selectedItems,[n]:[...e.selectedItems[n],{...r,quantity:1}]};let o={...e,selectedItems:a};return{...o,totals:Sr(o)}}case`INCREMENT_ITEM`:{let{category:n,itemId:r}=t.payload,i={...e.selectedItems,[n]:e.selectedItems[n].map(e=>e.id===r?{...e,quantity:(e.quantity||1)+1}:e)},a={...e,selectedItems:i};return{...a,totals:Sr(a)}}case`DECREMENT_ITEM`:{let{category:n,itemId:r}=t.payload,i=e.selectedItems[n].find(e=>e.id===r),a;a=i&&i.quantity<=1?{...e.selectedItems,[n]:e.selectedItems[n].filter(e=>e.id!==r)}:{...e.selectedItems,[n]:e.selectedItems[n].map(e=>e.id===r?{...e,quantity:e.quantity-1}:e)};let o={...e,selectedItems:a};return{...o,totals:Sr(o)}}case`REMOVE_ITEM`:{let{category:n,itemId:r}=t.payload,i={...e.selectedItems,[n]:e.selectedItems[n].filter(e=>e.id!==r)},a={...e,selectedItems:i};return{...a,totals:Sr(a)}}case`UPDATE_ITEM_POSITIONS`:{let{category:n,itemId:r,positions:i}=t.payload,a={...e.selectedItems,[n]:e.selectedItems[n].map(e=>e.id===r?{...e,positions:i}:e)};return{...e,selectedItems:a}}case`RESET`:return xr;default:return e}}function wr({children:e}){let[t,n]=(0,b.useReducer)(Cr,xr);return(0,P.jsx)(br.Provider,{value:{state:t,dispatch:n},children:e})}function Tr(){let e=(0,b.useContext)(br);if(!e)throw Error(`useBuilder must be used within a BuilderProvider`);return e}const Er={en:{step1:`Tent`,step2:`LIGHTS`,step3:`Ventilation`,step4:`Environment`,step5_media:`Medium`,step5:`Medium`,step6:`Nutrients`,step7:`Monitoring`,step8:`Summary`,next:`Next Step`,back:`Back`,finish:`Finish`,selectTent:`Select Tent Size`,tentDesc:`Choose a tent size that fits your space. This will determine the requirements for all other components.`,customDim:`Enter Custom Dimensions`,dimensions:`Dimensions`,area:`Area`,volume:`Volume`,width:`Width`,depth:`Depth`,height:`Height`,yourSpace:`Your Space`,recPower:`Recommended Power`,bestFit:`Best Fit`,coverage:`Coverage`,remainingCoverage:`Remaining Coverage`,lightPlacementTitle:`Light Placement & PPFD Map`,dragTip:`Drag to move. Double click to rotate 90°.`,avgPPFD:`Avg PPFD`,minPPFD:`Min PPFD`,maxPPFD:`Max PPFD`,uniformity:`Uniformity`,tentFloor:`Tent Floor`,seedling:`Seedling`,veg:`Veg`,flower:`Flower`,high:`High`,low:`Low`,reqCFM:`Required Airflow`,selFanPower:`Selected Fan Power`,inlineFans:`Inline Fans`,circFans:`Circulation Fans`,envDesc:`Select equipment to control temperature and humidity.`,humidifiers:`Humidifiers`,dehumidifiers:`Dehumidifiers`,heaters:`Heaters`,acs:`AC Units`,selectMedia:`Select Growing Medium`,mediaDesc:`Your choice of growing medium determines your watering style and nutrient requirements.`,mediaSoil:`Soil`,mediaSoilDesc:`Traditional, forgiving, great for beginners.`,mediaCoco:`Coco Coir`,mediaCocoDesc:`Hydroponic-like growth with soil-like feel.`,mediaHydro:`Hydroponics`,mediaHydroDesc:`Fastest growth, requires monitoring.`,nutesDesc:`Select nutrients and additives compatible with your chosen medium.`,monitorDesc:`Select devices to monitor and control your environment.`,buildingSetup:`Building your perfect setup...`,estCost:`Est. Cost`,power:`Power`,fullycovered:`Fully Covered!`,needMoreLight:`Need more light coverage`,yourSetup:`Your Setup`,reviewDesc:`Review your complete grow tent setup below.`,compatWarn:`Compatibility Warning`,warnLight:`Your selected fan may not provide enough airflow. Consider upgrading.`,warnCFM:`Your fan provides {cfm} CFM but you need {req} CFM for proper ventilation.`,totalEst:`Total Estimate`,tentDetails:`Tent Details`,equipCost:`Equipment Cost`,totalPower:`Total Power Draw`,estMonthly:`Est. Monthly Cost`,powerNote:`Based on 18hrs/day @ $0.12/kWh`,startOver:`Start Over`,restartConfirm:`Are you sure you want to start over? This will reset all your selections.`,printPdf:`Print / Save PDF`,knowledgeBase:`Knowledge Base`,knowledgeBaseSubtitle:`Expert guides, tips, and deep dives into plant technology.`,featuredArticle:`FEATURED ARTICLE`,blogCategoriesLabel:`blog categories :`,categoryAll:`All`,categoryLighting:`Lighting`,categoryHydroponics:`Hydroponics`,categoryEnvironment:`Environment`,categoryAutomation:`Automation`,categoryTraining:`Training`,categoryNutrients:`Nutrients`,categoryHarvest:`Harvest`,footer:`GroWizard © 2025 - Built for growers, by growers.`,footerHome:`Home`,footerBuilder:`Builder`,footerTools:`Tools`,footerBlog:`Blog`,footerRights:`© 2025 GroWizard. All rights reserved.`,navHome:`🏠 Home`,navBuilder:`Go To App 🚀`,navTools:`🛠️ Tools`,navBlog:`📝 Blog`,navCostCalc:`Electricity Cost Calculator`,navCo2Calc:`CO₂ Calculator`,navUnitConv:`Volume Converter`,navPpfdTool:`PPFD Heat Map`,switchToTr:`Switch to TR`,switchToEn:`Switch to EN`,landingTitle:`Design Your Perfect Harvest`,landingSubtitle:`Advanced simulation for serious growers. Calculate PPFD, estimate costs, and optimize your environment before you buy.`,landingCta:`Start Building Now`,landingPpfdTitle:`PPFD Simulation`,landingPpfdDesc:`Visualize light intensity and coverage with our advanced heatmap engine.`,landingCostTitle:`Cost Estimator`,landingCostDesc:`Calculate monthly electricity costs based on your local rates and equipment.`,landingEnvTitle:`Environment Control`,landingEnvDesc:`Match ventilation and filtration to your specific tent dimensions.`,landingCostToolTitle:`Quick Cost Calculator`,landingCostToolSubtitle:`Estimate your monthly electricity costs`,landingCostToolPower:`Total Power (Watts)`,landingCostToolHours:`Hours per Day`,landingCostToolRate:`Electricity Rate ($/kWh)`,landingCostToolCalculate:`Calculate`,landingCostToolResult:`Estimated Monthly Cost`,landingInfoTitle:`Critical Success Factors`,landingInfoSubtitle:`Essential knowledge for optimal plant growth`,landingInfoLight:`Light Intensity Matters`,landingInfoLightDesc:`Without proper PPFD levels for your plant type, growth will slow or stop completely.`,landingInfoAir:`Air Circulation is Essential`,landingInfoAirDesc:`Stagnant air increases mold and pest risk; fans are mandatory for healthy growth.`,landingInfoHumidity:`Humidity & Temperature Balance`,landingInfoHumidityDesc:`Excessive humidity or heat creates plant stress; controlled environment is crucial.`,landingFaqTitle:`Frequently Asked Questions`,landingFaqSubtitle:`Everything you need to know about indoor growing`,landingGrowTools:`Grow Tools`,landingGrowToolsSubtitle:`Everything you need for a successful harvest`,landingCostCalculator:`Cost Calculator`,landingCostCalculatorDesc:`Estimate electricity costs`,landingUnitConverter:`Unit Converter`,landingUnitConverterDesc:`Convert Liters & Gallons`,landingCo2Calculator:`CO2 Calculator`,landingCo2CalculatorDesc:`Find optimal CO2 levels`,landingViewAllTools:`View All Tools`,landingFeaturedGuides:`Featured Guides`,landingFeaturedGuidesSubtitle:`In-depth knowledge from experts`,landingReadMore:`Read More →`,landingLatestArticles:`Latest Articles`,landingLatestArticlesSubtitle:`Discover modern growing techniques`,landingViewAllArticles:`View All Articles`,landingBadge:`🌱 Professional Grow Planner`,toolsTitle:`Grow Tools`,toolsSubtitle:`Essential calculators and converters for your indoor garden`,toolCostTitle:`Electricity Cost Calculator`,toolCostDesc:`Estimate monthly electricity costs`,toolUnitTitle:`Unit Converter`,toolUnitDesc:`Convert between Liters, Gallons and more`,toolCo2Title:`CO2 Calculator`,toolCo2Desc:`Calculate CO2 requirements`,toolPpfdTitle:`PPFD Heat Map`,toolPpfdDesc:`Visualize light intensity distribution`,costCalcTitle:`Electricity Cost Calculator`,costCalcSubtitle:`Calculate the cost of running your grow equipment`,costCalcPower:`Power consumption`,costCalcTime:`Usage time`,costCalcPrice:`Energy price`,costCalcEnergy:`Energy consumed`,costCalcCost:`Cost`,costCalcW:`W`,costCalcHrs:`hrs`,costCalcMin:`min`,costCalcKwh:`kWh`,costCalcCurrency:`$`,costCalcIntroTitle:`How to calculate electricity cost`,costCalcIntroText:`If you're wondering how much electricity costs, all you need to know is the power consumption of your electrical device, how long it runs, and the actual energy prices offered by your supplier. The calculation runs in two steps.`,costCalcIntroStep1:`First, multiply power consumption of your device by usage time to find how much energy your device consumed: power consumption × usage time = energy consumed`,costCalcIntroStep2:`Then, check the electricity cost per kWh from your local energy supplier and multiply it by the amount of energy consumed: cost = energy consumed × energy price`,costCalcIntroExample:`Example: 700W vacuum for 30 mins. 700W × 0.5h = 350Wh = 0.35 kWh. 0.35 kWh × $0.14/kWh = $0.05.`,costCalcWorksTitle:`How electricity cost – single usage calculator works`,costCalcWorksText:`Our electricity cost – single usage calculator needs just a few steps to tell you how much electricity costs once the selected device is running:`,costCalcWorksList1:`Determine power consumption of your device in watts.`,costCalcWorksList2:`Enter usage time (hours and minutes).`,costCalcWorksList3:`The calculator returns the energy consumed in kWh.`,costCalcWorksList4:`Enter the actual electricity cost per kWh to see the total cost.`,costCalcTipsTitle:`How to lower your electric bill`,costCalcTip1:`Get a home energy audit.`,costCalcTip2:`Switch to dimmer switches.`,costCalcTip3:`Keep your fridge and freezer closed.`,costCalcTip4:`Keep the air circulating in your home with ceiling fans.`,costCalcTip5:`Eliminate phantom loads from televisions, computers, etc.`,costCalcTip6:`Switch to LED light bulbs.`,costCalcTip7:`Shade your home with trees, curtains, and blinds.`,costCalcTip8:`Use cool water for laundry.`,costCalcTip9:`Wash laundry in full loads or use 'eco' mode.`,costCalcTip10:`Install a water heater timer.`,costCalcTip11:`Check if your home is properly insulated.`,costCalcFaqTitle:`FAQs`,costCalcFaq1Q:`How to calculate my electric bill?`,costCalcFaq1A:`Get the power of each device, multiply by operating time to get energy consumption (convert to kWh), then multiply by electricity cost.`,costCalcFaq2Q:`How much does it cost to run a 1500 watt oven?`,costCalcFaq2A:`$0.36 for 1.5 hours at $0.16/kWh. (1500W × 1.5h = 2.25 kWh. 2.25 kWh × $0.16 = $0.36).`,costCalcFaq3Q:`What uses a lot of electricity?`,costCalcFaq3A:`Electrical heaters, water heaters, and HVAC systems consume a lot of electricity.`,costCalcFaq4Q:`Is 100 kWh per day a lot?`,costCalcFaq4A:`Yes. 100 kWh/day = 3000 kWh/month, which exceeds the U.S. average of 893 kWh/month.`,co2CalcTitle:`CO₂ Grow Room Calculator`,co2CalcSubtitle:`Optimize your grow space with precise CO₂ calculations`,co2CalcDims:`Room Dimensions (cm)`,co2CalcTarget:`Target CO₂ Level (PPM)`,co2CalcFillTime:`Desired Fill Time (minutes)`,co2CalcVolume:`Room Volume`,co2CalcRequired:`Required CO₂ Amount`,co2CalcFlow:`Required Flow Rate`,co2CalcIntroTitle:`How much CO₂ to add to a grow room?`,co2CalcIntroText:`Find out how much CO2 to add to a grow room with our CO2 grow room calculator! Read on to learn the optimum CO2 level for plant growth and how to calculate the CO2 flow rate of a tank to reach that level. But first, let's answer the most critical question: why would you add CO2 to a grow room?`,co2CalcIntroText2:`As you may or may not know, plants perform photosynthesis, transforming carbon dioxide, water, and sunlight into oxygen and compounds they use to grow. While we have plenty of CO2 in the atmosphere (around 420 ppm), adding more CO2 may be beneficial if you care about yield. However, adding CO2 alone won't do much. You also need to provide enough nutrients, water, and light. Even if you add plenty of CO2, the amount of light can be a limiting factor if it's not intense enough, and the CO2 will go to waste.`,co2CalcHowTitle:`How to use the CO₂ grow room calculator?`,co2CalcHowText:`To calculate the volume of CO2 for a grow tent, you need to know the following:`,co2CalcHowList1:`The dimensions or volume of the room/tent`,co2CalcHowList2:`The current and desired CO2 levels in parts per million (ppm)`,co2CalcHowText2:`Then you can use the calculator above to find how much CO2 you need to add to your grow room.`,co2CalcFaqTitle:`FAQs`,co2CalcFaq1Q:`What is the optimal CO2 level?`,co2CalcFaq1A:`For most plants, 1200-1500 PPM is considered optimal during the flowering stage with high light intensity.`,co2CalcFaq2Q:`When should I add CO2?`,co2CalcFaq2A:`CO2 should only be added when the lights are ON. Plants do not use CO2 during the dark period.`,co2CalcFaq3Q:`Do I need to seal my room?`,co2CalcFaq3A:`Yes, a sealed room is best to prevent CO2 from escaping. If using an exhaust fan, it should be timed or controlled to minimize waste.`,unitConvTitle:`Volume Converter`,unitConvSubtitle:`Convert freely between imperial and metric volume units`,unitConvMl:`Milliliters (ml)`,unitConvL:`Liters (L)`,unitConvGal:`Gallons (US gal)`,unitConvQt:`Quarts (US qt)`,unitConvPt:`Pints (US pt)`,unitConvCup:`Cups (US cup)`,unitConvFloz:`Fluid Ounces (US fl oz)`,unitConvTbsp:`Tablespoons (tbsp)`,unitConvTsp:`Teaspoons (tsp)`,unitConvM3:`Cubic Meters (m³)`,unitConvFt3:`Cubic Feet (ft³)`,unitConvIntroTitle:`Volume units`,unitConvIntroText:`Choose the unit and convert freely between imperial and metric systems. Our calculator contains the following:`,unitConvIntroNote:`*Some units are simplified in this view for common usage.`,unitConvChartTitle:`Volume conversion chart`,unitConvChartText:`One quick way of changing imperial volume units to the most popular metric, one milliliter, is using this conversion chart:`,unitConvChartMeasure:`Measure`,unitConvChartUS:`US (ml)`,unitConvChartMetric:`Metric (ml)`,unitConvHowTitle:`How to find the volume in a different unit`,unitConvHowText:`Let's imagine that you want to bake a cake, but the problem is that the recipe comes from a different part of the world. You are used to your standard units, such as cups or pints, but you have no idea how much is 550 ml of milk. What can you do? Put that value in the calculator next to the milliliters unit, and immediately you will get the answer in cups (2.32), pints (1.16), or even teaspoons (110) if you wish.`,unitConvFaqTitle:`FAQs`,unitConvFaq1Q:`How do I convert from liters to gallons?`,unitConvFaq1A:`To convert from liters to gallons, use the formula: 1 L = 0.264 gal (US). You can roughly divide by 4 for a quick estimate.`,unitConvFaq2Q:`How much is 5 liters in cubic feet?`,unitConvFaq2A:`5 liters equal to 0.177 cubic feet (ft³). Formula: 5 L / 1000 * 35.315 = 0.177 ft³.`,unitConvFaq3Q:`Why do we measure volume in cubic meters?`,unitConvFaq3A:`We measure volume in cubic meters because volume measures the space occupied in three dimensions. Since the meter is a measure of length, the cubic meter (m³) represents a three-dimensional quantity.`,ppfdToolTitle:`Advanced PPFD Heat Map`,ppfdToolSubtitle:`Visualize light intensity and optimize your grow space`,ppfdToolDimensions:`Room Dimensions`,ppfdToolAddLight:`Add Light Source`,ppfdToolHeight:`Global Light Height`,ppfdToolAvg:`Average PPFD`,ppfdToolMin:`Min PPFD`,ppfdToolMax:`Max PPFD`,ppfdToolUni:`Uniformity`,ppfdToolLegendLow:`Low (<200)`,ppfdToolLegendSeedling:`Seedling (200-400)`,ppfdToolLegendVeg:`Veg (400-600)`,ppfdToolLegendFlower:`Flower (600-900)`,ppfdToolLegendHigh:`High (900-1200)`,ppfdToolLegendExtreme:`Extreme (>1200)`,ppfdToolInstructions:`Drag lights to position. Double click to rotate.`,ppfdToolUnitToggle:`Unit System`,notFoundTitle:`404 - Light Leak!`,notFoundDescription:`You've wandered into the dark cycle.`,notFoundHeadline:`404: Light Leak Detected!`,notFoundSubtext:`Shhh! The plants are sleeping.`,notFoundMessage:`You've wandered into the dark cycle. Let's get you back to the light before they get stressed.`,notFoundButton:`Return to Garden 🌿`,onboardingStep:`Step`,onboardingContinue:`Continue →`,onboardingBack:`← Back`,onboardingSkip:`Skip`,onboardingQ1:`What types of plants do you plan to grow?`,onboardingQ1Opt1Label:`Aromatic herbs`,onboardingQ1Opt1Detail:`(basil, mint, thyme)`,onboardingQ1Opt2Label:`Vegetables`,onboardingQ1Opt2Detail:`(tomato, pepper, lettuce)`,onboardingQ1Opt3Label:`Flowering plants`,onboardingQ1Opt3Detail:`(orchid, geranium)`,onboardingQ1Tip1:`Aromatic herbs can thrive at low PPFD levels, so they can be efficiently grown with less powerful lights.`,onboardingQ1Tip2:`Vegetables, especially during flowering and fruiting, require high light (600+ µmol/m²/s).`,onboardingQ1Tip3:`For flowering plants, spectrum balance is as important as light continuity; red and blue light ratios affect flowering.`,onboardingQ2:`What is your growing experience?`,onboardingQ2Opt1Label:`Just starting`,onboardingQ2Opt2Label:`Intermediate`,onboardingQ2Opt3Label:`Experienced`,onboardingQ2Tip1:`For beginners, auto-timer lights and simple soil mixes are ideal.`,onboardingQ2Tip2:`Intermediate users can benefit from low-cost sensors and small ventilation systems to increase yield.`,onboardingQ2Tip3:`Experienced users can optimize lamp positioning by creating PPFD maps.`,onboardingQ3:`How much space do you plan to allocate?`,onboardingQ3Opt1Label:`Small cabinet`,onboardingQ3Opt1Detail:`(60×60 cm)`,onboardingQ3Opt2Label:`Medium tent`,onboardingQ3Opt2Detail:`(100×100 cm)`,onboardingQ3Opt3Label:`Large area`,onboardingQ3Opt3Detail:`(120×120 cm and above)`,onboardingQ3Tip1:`Temperature control can be difficult in small spaces, so quiet fans and low-heat LEDs should be preferred.`,onboardingQ3Tip2:`For these dimensions, 240-320W LED products are a good starting point.`,onboardingQ3Tip3:`Large areas require stronger ventilation and 480W+ LED equipment.`,onboardingQ4:`What is your lighting system preference?`,onboardingQ4Opt1Label:`LED`,onboardingQ4Opt1Detail:`(energy efficient, low heat)`,onboardingQ4Opt2Label:`HPS`,onboardingQ4Opt2Detail:`(high pressure sodium)`,onboardingQ4Opt3Label:`Not sure`,onboardingQ4Opt3Detail:`I want recommendations`,onboardingQ4Tip1:`LEDs are long-lasting and models with different spectrums provide light suitable for plant development stages.`,onboardingQ4Tip2:`HPS lamps provide intense light during flowering, but emit more heat and consume more energy.`,onboardingQ4Tip3:`LED technology is more advantageous for most users initially and in the long run; it stands out with low heat and modular design.`,onboardingQ5:`What will be your automation level?`,onboardingQ5Opt1Label:`Fully manual`,onboardingQ5Opt1Detail:`(watering, light control, etc.)`,onboardingQ5Opt2Label:`Semi-automatic`,onboardingQ5Opt2Detail:`(timer, fan control)`,onboardingQ5Opt3Label:`Fully automatic`,onboardingQ5Opt3Detail:`(climate control, humidity, watering)`,onboardingQ5Tip1:`Manual systems are low budget but require attention; daily checks should not be neglected.`,onboardingQ5Tip2:`Simple timers and sensor-supported fans increase efficiency and reduce error margin.`,onboardingQ5Tip3:`Full automation increases yield but has high initial cost; ideal for advanced users.`},tr:{step1:`Çadır`,step2:`Işık`,step3:`Havalandırma`,step4:`İklimlendirme`,step5_media:`Medya`,step5:`Medya`,step6:`Besinler`,step7:`Takip`,step8:`Özet`,next:`Sonraki Adım`,back:`Geri`,finish:`Bitir`,selectTent:`Çadır Boyutu Seçin`,tentDesc:`Alanınıza uygun bir çadır boyutu seçin. Bu, diğer tüm bileşenlerin gereksinimlerini belirleyecektir.`,customDim:`Özel Boyut Girin`,dimensions:`Boyutlar`,area:`Alan`,volume:`Hacim`,width:`Genişlik`,depth:`Derinlik`,height:`Yükseklik`,yourSpace:`Alanınız`,recPower:`Önerilen Güç`,bestFit:`En Uygun`,coverage:`Kapsama Alanı`,remainingCoverage:`Kalan Kapsama Alanı`,lightPlacementTitle:`Işık Yerleşimi ve PPFD Haritası`,dragTip:`Taşımak için sürükleyin. 90° döndürmek için çift tıklayın.`,avgPPFD:`Ort. PPFD`,minPPFD:`Min PPFD`,maxPPFD:`Maks PPFD`,uniformity:`Homojenlik`,tentFloor:`Çadır Tabanı`,seedling:`Fidan`,veg:`Vejetasyon`,flower:`Çiçeklenme`,high:`Yüksek`,low:`Düşük`,reqCFM:`Gerekli Hava Akışı`,selFanPower:`Seçilen Fan Gücü`,inlineFans:`Kanal Tipi Fanlar`,circFans:`Sirkülasyon Fanları`,envDesc:`Sıcaklık ve nemi kontrol etmek için ekipman seçin.`,humidifiers:`Nemlendiriciler`,dehumidifiers:`Nem Alma Cihazları`,heaters:`Isıtıcılar`,acs:`Klimalar`,selectMedia:`Yetiştirme Medyası Seçin`,mediaDesc:`Yetiştirme medyası seçiminiz, sulama tarzınızı ve besin gereksinimlerinizi belirleyecektir.`,mediaSoil:`Toprak`,mediaSoilDesc:`Geleneksel, bağışlayıcı, yeni başlayanlar için harika.`,mediaCoco:`Hindistan Cevizi Lifi`,mediaCocoDesc:`Toprak hissi ile hidroponik benzeri büyüme.`,mediaHydro:`Hidroponik`,mediaHydroDesc:`En hızlı büyüme, izleme gerektirir.`,nutesDesc:`Seçtiğiniz medyaya uygun besinleri ve katkı maddelerini seçin.`,monitorDesc:`Ortamınızı izlemek ve kontrol etmek için cihazlar seçin.`,buildingSetup:`Mükemmel kurulumunuzu oluşturuyoruz...`,estCost:`Tahmini Maliyet`,power:`Güç`,fullycovered:`Tamamen Kapsandı!`,needMoreLight:`Daha fazla ışık kapsamı gerekiyor`,yourSetup:`Kurulumunuz`,reviewDesc:`Tam büyütme çadırı kurulumunuzu aşağıda inceleyin.`,compatWarn:`Uyumluluk Uyarısı`,warnLight:`Seçtiğiniz fan yeterli hava akışı sağlamayabilir. Yükseltmeyi düşünün.`,warnCFM:`Fanınız {cfm} CFM sağlıyor ancak düzgün havalandırma için {req} CFM gerekiyor.`,totalEst:`Toplam Tahmin`,tentDetails:`Çadır Detayları`,equipCost:`Ekipman Maliyeti`,totalPower:`Toplam Güç Tüketimi`,estMonthly:`Tahmini Aylık Maliyet`,powerNote:`Günde 18 saat @ $0.12/kWh baz alınarak`,startOver:`Baştan Başla`,restartConfirm:`Baştan başlamak istediğinizden emin misiniz? Bu, tüm seçimlerinizi sıfırlayacaktır.`,printPdf:`Yazdır / PDF Kaydet`,knowledgeBase:`Bilgi Bankası`,knowledgeBaseSubtitle:`Bitki teknolojisine dair uzman rehberleri, ipuçları ve derinlemesine incelemeler.`,featuredArticle:`ÖNE ÇIKAN MAKALE`,blogCategoriesLabel:`blog kategorileri :`,categoryAll:`Tümü`,categoryLighting:`Aydınlatma`,categoryHydroponics:`Hidroponik`,categoryEnvironment:`Ortam`,categoryAutomation:`Otomasyon`,categoryTraining:`Eğitim`,categoryNutrients:`Besinler`,categoryHarvest:`Hasat`,footer:`GroWizard © 2025 - Yetiştiriciler için, yetiştiriciler tarafından yapıldı.`,footerHome:`Ana Sayfa`,footerBuilder:`Oluşturucu`,footerTools:`Araçlar`,footerBlog:`Blog`,footerRights:`© 2025 GroWizard. Tüm hakları saklıdır.`,navHome:`🏠 Ana Sayfa`,navBuilder:`Uygulamaya Git 🚀`,navTools:`🛠️ Araçlar`,navBlog:`📝 Blog`,navCostCalc:`Elektrik Maliyeti Hesaplayıcı`,navCo2Calc:`CO₂ Hesaplayıcı`,navUnitConv:`Hacim Çevirici`,navPpfdTool:`PPFD Isı Haritası`,switchToTr:`Switch to TR`,switchToEn:`Switch to EN`,landingTitle:`Mükemmel Hasadınızı Tasarlayın`,landingSubtitle:`Ciddi yetiştiriciler için gelişmiş simülasyon. PPFD hesaplayın, maliyetleri tahmin edin ve satın almadan önce ortamınızı optimize edin.`,landingCta:`Hemen Başla`,landingPpfdTitle:`PPFD Simülasyonu`,landingPpfdDesc:`Gelişmiş ısı haritası motorumuzla ışık yoğunluğunu ve kapsamını görselleştirin.`,landingCostTitle:`Maliyet Hesaplayıcı`,landingCostDesc:`Yerel tarifelerinize ve ekipmanınıza göre aylık elektrik maliyetlerini hesaplayın.`,landingEnvTitle:`Ortam Kontrolü`,landingEnvDesc:`Havalandırma ve filtrasyonu çadır boyutlarınıza göre eşleştirin.`,landingCostToolTitle:`Hızlı Maliyet Hesaplayıcı`,landingCostToolSubtitle:`Aylık elektrik maliyetlerinizi tahmin edin`,landingCostToolPower:`Toplam Güç (Watt)`,landingCostToolHours:`Günlük Saat`,landingCostToolRate:`Elektrik Tarifesi (₺/kWh)`,landingCostToolCalculate:`Hesapla`,landingCostToolResult:`Tahmini Aylık Maliyet`,landingInfoTitle:`Kritik Başarı Faktörleri`,landingInfoSubtitle:`Optimal bitki gelişimi için temel bilgiler`,landingInfoLight:`Işık Yoğunluğu Önemlidir`,landingInfoLightDesc:`Bitkinin türüne uygun PPFD seviyesi olmazsa gelişim yavaşlar veya durur.`,landingInfoAir:`Hava Sirkülasyonu Şarttır`,landingInfoAirDesc:`Durgun hava küf ve haşere riskini artırır; mutlaka fan kullanılmalı.`,landingInfoHumidity:`Nem ve Sıcaklık Dengesi`,landingInfoHumidityDesc:`Aşırı nem ya da ısı bitkide stres yaratır; kontrollü ortam şart.`,landingFaqTitle:`Sıkça Sorulan Sorular`,landingFaqSubtitle:`İç mekan yetiştiriciliği hakkında bilmeniz gerekenler`,landingGrowTools:`Yetiştirme Araçları`,landingGrowToolsSubtitle:`Başarılı bir hasat için ihtiyacınız olan her şey`,landingCostCalculator:`Maliyet Hesaplayıcı`,landingCostCalculatorDesc:`Elektrik masraflarınızı hesaplayın`,landingUnitConverter:`Birim Çevirici`,landingUnitConverterDesc:`Litre ve Galon dönüşümü`,landingCo2Calculator:`CO2 Hesaplayıcı`,landingCo2CalculatorDesc:`Optimal CO2 seviyelerini bulun`,landingViewAllTools:`Tüm Araçları Gör`,landingFeaturedGuides:`Öne Çıkan Rehberler`,landingFeaturedGuidesSubtitle:`Uzmanlardan derinlemesine bilgiler`,landingReadMore:`Devamını Oku →`,landingLatestArticles:`En Son Makaleler`,landingLatestArticlesSubtitle:`Modern yetiştiricilik tekniklerini keşfedin`,landingViewAllArticles:`Tüm Yazıları Gör`,landingBadge:`🌱 Profesyonel Yetiştirme Planlayıcısı`,toolsTitle:`Yetiştirme Araçları`,toolsSubtitle:`İç mekan bahçeniz için temel hesaplayıcılar ve dönüştürücüler`,toolCostTitle:`Elektrik Maliyeti Hesaplayıcı`,toolCostDesc:`Aylık elektrik maliyetini hesaplayın`,toolUnitTitle:`Birim Çevirici`,toolUnitDesc:`Litre, Galon ve diğer birimler arası dönüşüm`,toolCo2Title:`CO2 Hesaplayıcı`,toolCo2Desc:`CO2 gereksinimlerini hesaplayın`,toolPpfdTitle:`PPFD Isı Haritası`,toolPpfdDesc:`Işık yoğunluğu dağılımını görselleştirin`,costCalcTitle:`Elektrik Maliyeti Hesaplayıcı`,costCalcSubtitle:`Ekipmanlarınızı çalıştırmanın maliyetini hesaplayın`,costCalcPower:`Güç tüketimi`,costCalcTime:`Kullanım süresi`,costCalcPrice:`Enerji fiyatı`,costCalcEnergy:`Tüketilen enerji`,costCalcCost:`Maliyet`,costCalcW:`W`,costCalcHrs:`saat`,costCalcMin:`dk`,costCalcKwh:`kWh`,costCalcCurrency:`₺`,costCalcIntroTitle:`Elektrik maliyeti nasıl hesaplanır`,costCalcIntroText:`Elektriğin ne kadar tuttuğunu merak ediyorsanız, bilmeniz gereken tek şey elektrikli cihazınızın güç tüketimi, ne kadar süre çalıştığı ve tedarikçiniz tarafından sunulan gerçek enerji fiyatlarıdır. Hesaplama iki adımda gerçekleşir.`,costCalcIntroStep1:`İlk olarak, cihazınızın ne kadar enerji tükettiğini bulmak için güç tüketimini kullanım süresiyle çarpın: güç tüketimi × kullanım süresi = tüketilen enerji`,costCalcIntroStep2:`Ardından, yerel enerji tedarikçinizden kWh başına elektrik maliyetini kontrol edin ve bunu tüketilen enerji miktarıyla çarpın: maliyet = tüketilen enerji × enerji fiyatı`,costCalcIntroExample:`Örnek: 30 dakika boyunca 700W süpürge. 700W × 0.5sa = 350Wh = 0.35 kWh. 0.35 kWh × 0.14₺/kWh = 0.05₺.`,costCalcWorksTitle:`Elektrik maliyeti hesaplayıcı nasıl çalışır`,costCalcWorksText:`Elektrik maliyeti hesaplayıcımız, seçilen cihaz çalıştığında elektriğin ne kadar tuttuğunu size söylemek için sadece birkaç adıma ihtiyaç duyar:`,costCalcWorksList1:`Cihazınızın güç tüketimini watt cinsinden belirleyin.`,costCalcWorksList2:`Kullanım süresini (saat ve dakika) girin.`,costCalcWorksList3:`Hesaplayıcı, tüketilen enerjiyi kWh cinsinden döndürür.`,costCalcWorksList4:`Toplam maliyeti görmek için kWh başına gerçek elektrik maliyetini girin.`,costCalcTipsTitle:`Elektrik faturanızı nasıl düşürürsünüz`,costCalcTip1:`Ev enerji denetimi yaptırın.`,costCalcTip2:`Dimmer anahtarlara geçin.`,costCalcTip3:`Buzdolabınızı ve dondurucunuzu kapalı tutun.`,costCalcTip4:`Tavan vantilatörleri ile evinizdeki havayı dolaştırın.`,costCalcTip5:`Televizyonlar, bilgisayarlar vb. cihazlardan kaynaklanan hayalet yükleri ortadan kaldırın.`,costCalcTip6:`LED ampullere geçin.`,costCalcTip7:`Evinizi ağaçlar, perdeler ve panjurlarla gölgeleyin.`,costCalcTip8:`Çamaşır için soğuk su kullanın.`,costCalcTip9:`Çamaşırları tam yükte yıkayın veya 'eko' modunu kullanın.`,costCalcTip10:`Su ısıtıcı zamanlayıcısı takın.`,costCalcTip11:`Evinizin uygun şekilde yalıtılıp yalıtılmadığını kontrol edin.`,costCalcFaqTitle:`SSS`,costCalcFaq1Q:`Elektrik faturamı nasıl hesaplarım?`,costCalcFaq1A:`Her cihazın gücünü alın, enerji tüketimini (kWh'ye çevirin) elde etmek için çalışma süresiyle çarpın, ardından elektrik maliyetiyle çarpın.`,costCalcFaq2Q:`1500 watt'lık bir fırını çalıştırmak ne kadara mal olur?`,costCalcFaq2A:`1.5 saat için 0.16₺/kWh fiyatla 0.36₺. (1500W × 1.5sa = 2.25 kWh. 2.25 kWh × 0.16 = 0.36₺).`,costCalcFaq3Q:`Ne çok elektrik tüketir?`,costCalcFaq3A:`Elektrikli ısıtıcılar, su ısıtıcıları ve HVAC sistemleri çok fazla elektrik tüketir.`,costCalcFaq4Q:`Günde 100 kWh çok mu?`,costCalcFaq4A:`Evet. Günde 100 kWh = ayda 3000 kWh, bu da ortalamanın oldukça üzerindedir.`,co2CalcTitle:`CO₂ Yetiştirme Odası Hesaplayıcı`,co2CalcSubtitle:`Hassas CO₂ hesaplamalarıyla yetiştirme alanınızı optimize edin`,co2CalcDims:`Oda Boyutları (cm)`,co2CalcTarget:`Hedef CO₂ Seviyesi (PPM)`,co2CalcFillTime:`İstenen Dolum Süresi (dakika)`,co2CalcVolume:`Oda Hacmi`,co2CalcRequired:`Gerekli CO₂ Miktarı`,co2CalcFlow:`Gerekli Akış Hızı`,co2CalcIntroTitle:`Yetiştirme odasına ne kadar CO₂ eklenmeli?`,co2CalcIntroText:`CO2 yetiştirme odası hesaplayıcımızla yetiştirme odasına ne kadar CO2 ekleneceğini öğrenin! Bitki büyümesi için optimum CO2 seviyesini ve bu seviyeye ulaşmak için bir tankın CO2 akış hızını nasıl hesaplayacağınızı öğrenmek için okumaya devam edin. Ama önce en kritik soruyu cevaplayalım: neden bir yetiştirme odasına CO2 ekleyesiniz?`,co2CalcIntroText2:`Bildiğiniz veya bilmediğiniz gibi, bitkiler fotosentez yapar; karbondioksit, su ve güneş ışığını oksijene ve büyümek için kullandıkları bileşiklere dönüştürür. Atmosferde bol miktarda CO2 (yaklaşık 420 ppm) bulunsa da, verimi önemsiyorsanız daha fazla CO2 eklemek faydalı olabilir. Ancak, sadece CO2 eklemek pek bir işe yaramaz. Ayrıca yeterli besin, su ve ışık sağlamanız gerekir. Bol miktarda CO2 ekleseniz bile, ışık miktarı yeterince yoğun değilse sınırlayıcı bir faktör olabilir ve CO2 boşa gider.`,co2CalcHowTitle:`CO₂ yetiştirme odası hesaplayıcısı nasıl kullanılır?`,co2CalcHowText:`Bir yetiştirme çadırı için CO2 hacmini hesaplamak için aşağıdakileri bilmeniz gerekir:`,co2CalcHowList1:`Odanın/çadırın boyutları veya hacmi`,co2CalcHowList2:`Milyonda parça (ppm) cinsinden mevcut ve istenen CO2 seviyeleri`,co2CalcHowText2:`Ardından, yetiştirme odanıza ne kadar CO2 eklemeniz gerektiğini bulmak için yukarıdaki hesaplayıcıyı kullanabilirsiniz.`,co2CalcFaqTitle:`Sıkça Sorulan Sorular`,co2CalcFaq1Q:`Optimal CO2 seviyesi nedir?`,co2CalcFaq1A:`Çoğu bitki için, yüksek ışık yoğunluğuyla çiçeklenme döneminde 1200-1500 PPM optimal kabul edilir.`,co2CalcFaq2Q:`Ne zaman CO2 eklemeliyim?`,co2CalcFaq2A:`CO2 sadece ışıklar AÇIKKEN eklenmelidir. Bitkiler karanlık dönemde CO2 kullanmazlar.`,co2CalcFaq3Q:`Odamı yalıtmam gerekir mi?`,co2CalcFaq3A:`Evet, CO2'nin kaçmasını önlemek için yalıtılmış bir oda en iyisidir. Egzoz fanı kullanıyorsanız, israfı en aza indirmek için zamanlanmalı veya kontrol edilmelidir.`,unitConvTitle:`Hacim Çevirici`,unitConvSubtitle:`İmperyal ve metrik hacim birimleri arasında özgürce dönüşüm yapın`,unitConvMl:`Mililitre (ml)`,unitConvL:`Litre (L)`,unitConvGal:`Galon (US gal)`,unitConvQt:`Çeyrek (US qt)`,unitConvPt:`Pint (US pt)`,unitConvCup:`Fincan (US cup)`,unitConvFloz:`Sıvı Ons (US fl oz)`,unitConvTbsp:`Yemek Kaşığı (tbsp)`,unitConvTsp:`Çay Kaşığı (tsp)`,unitConvM3:`Metreküp (m³)`,unitConvFt3:`Fitküp (ft³)`,unitConvIntroTitle:`Hacim birimleri`,unitConvIntroText:`Birimi seçin ve imperyal ve metrik sistemler arasında özgürce dönüştürün. Hesaplayıcımız şunları içerir:`,unitConvIntroNote:`*Bazı birimler yaygın kullanım için bu görünümde basitleştirilmiştir.`,unitConvChartTitle:`Hacim dönüşüm tablosu`,unitConvChartText:`İmperyal hacim birimlerini en popüler metrik birim olan mililitreye değiştirmenin hızlı bir yolu bu dönüşüm tablosunu kullanmaktır:`,unitConvChartMeasure:`Ölçü`,unitConvChartUS:`ABD (ml)`,unitConvChartMetric:`Metrik (ml)`,unitConvHowTitle:`Farklı bir birimde hacim nasıl bulunur`,unitConvHowText:`Diyelim ki bir kek yapmak istiyorsunuz, ancak sorun şu ki tarif dünyanın farklı bir yerinden geliyor. Fincan veya pint gibi standart birimlerinize alışkınsınız, ancak 550 ml sütün ne kadar olduğu hakkında hiçbir fikriniz yok. Ne yapabilirsiniz? Bu değeri hesaplayıcıda mililitre biriminin yanına koyun ve hemen fincan (2.32), pint (1.16) veya isterseniz çay kaşığı (110) cinsinden cevabı alacaksınız.`,unitConvFaqTitle:`SSS`,unitConvFaq1Q:`Litreyi galona nasıl çeviririm?`,unitConvFaq1A:`Litreyi galona çevirmek için şu formülü kullanın: 1 L = 0.264 gal (ABD). Hızlı bir tahmin için 4'e bölebilirsiniz.`,unitConvFaq2Q:`5 litre kaç fitküptür?`,unitConvFaq2A:`5 litre 0.177 fitküpe (ft³) eşittir. Formül: 5 L / 1000 * 35.315 = 0.177 ft³.`,unitConvFaq3Q:`Neden hacmi metreküp olarak ölçüyoruz?`,unitConvFaq3A:`Hacmi metreküp olarak ölçüyoruz çünkü hacim, bir nesnenin üç boyutta kapladığı alanı ölçer. Metre bir uzunluk ölçüsü olduğundan, metreküp (m³) üç boyutlu bir niceliği temsil eder.`,ppfdToolTitle:`Gelişmiş PPFD Isı Haritası`,ppfdToolSubtitle:`Işık yoğunluğunu görselleştirin ve alanınızı optimize edin`,ppfdToolDimensions:`Oda Boyutları`,ppfdToolAddLight:`Işık Kaynağı Ekle`,ppfdToolHeight:`Genel Işık Yüksekliği`,ppfdToolAvg:`Ortalama PPFD`,ppfdToolMin:`Min PPFD`,ppfdToolMax:`Maks PPFD`,ppfdToolUni:`Üniformite`,ppfdToolLegendLow:`Düşük (<200)`,ppfdToolLegendSeedling:`Fide (200-400)`,ppfdToolLegendVeg:`Gelişim (400-600)`,ppfdToolLegendFlower:`Çiçek (600-900)`,ppfdToolLegendHigh:`Yüksek (900-1200)`,ppfdToolLegendExtreme:`Aşırı (>1200)`,ppfdToolInstructions:`Işıkları sürükleyerek konumlandırın. Döndürmek için çift tıklayın.`,ppfdToolUnitToggle:`Birim Sistemi`,notFoundTitle:`404 - Işık Sızıntısı!`,notFoundDescription:`Karanlık döngüye girdiniz.`,notFoundHeadline:`404: Işık Sızıntısı Tespit Edildi!`,notFoundSubtext:`Şşşt! Bitkiler uyuyor.`,notFoundMessage:`Karanlık döngüye girdiniz. Bitkiler strese girmeden sizi ışığa geri döndürelim.`,notFoundButton:`Bahçeye Dön 🌿`,onboardingStep:`Adım`,onboardingContinue:`Devam Et →`,onboardingBack:`← Geri`,onboardingSkip:`Atla`,onboardingQ1:`Hangi bitki türlerini yetiştirmeyi planlıyorsunuz?`,onboardingQ1Opt1Label:`Aromatik otlar`,onboardingQ1Opt1Detail:`(fesleğen, nane, kekik)`,onboardingQ1Opt2Label:`Sebzeler`,onboardingQ1Opt2Detail:`(domates, biber, marul)`,onboardingQ1Opt3Label:`Çiçekli bitkiler`,onboardingQ1Opt3Detail:`(orkide, sardunya)`,onboardingQ1Tip1:`Aromatik otlar düşük PPFD seviyelerinde bile gelişebilir, bu nedenle daha az güçlü ışıklarla da verimli yetiştirilebilir.`,onboardingQ1Tip2:`Sebzeler özellikle çiçeklenme ve meyve verme dönemlerinde yüksek ışık (600+ µmol/m²/s) ister.`,onboardingQ1Tip3:`Çiçekli bitkiler için ışık sürekliliği kadar spektrum dengesi de önemlidir; kırmızı ve mavi ışık oranı çiçeklenmeyi etkiler.`,onboardingQ2:`Yetiştiricilik deneyiminiz nedir?`,onboardingQ2Opt1Label:`Yeni başlıyorum`,onboardingQ2Opt2Label:`Orta seviye`,onboardingQ2Opt3Label:`Deneyimliyim`,onboardingQ2Tip1:`Yeni başlayanlar için otomatik zamanlayıcılı ışıklar ve basit toprak karışımları idealdir.`,onboardingQ2Tip2:`Orta seviye kullanıcılar için düşük maliyetli sensörler ve küçük havalandırma sistemleri verimi artırabilir.`,onboardingQ2Tip3:`Deneyimli kullanıcılar PPFD haritası çıkararak lamba konumlandırmasını optimize edebilir.`,onboardingQ3:`Ne kadar alan ayırmayı planlıyorsunuz?`,onboardingQ3Opt1Label:`Küçük kabin`,onboardingQ3Opt1Detail:`(60×60 cm)`,onboardingQ3Opt2Label:`Orta boy çadır`,onboardingQ3Opt2Detail:`(100×100 cm)`,onboardingQ3Opt3Label:`Büyük alan`,onboardingQ3Opt3Detail:`(120×120 cm ve üzeri)`,onboardingQ3Tip1:`Küçük alanlarda sıcaklık kontrolü zor olabilir, bu yüzden sessiz fanlar ve düşük ısı yayan LED'ler tercih edilmeli.`,onboardingQ3Tip2:`Bu boyutlar için 240–320W LED arası ürünler iyi bir başlangıç noktasıdır.`,onboardingQ3Tip3:`Geniş alanlar güçlü havalandırma ve 480W+ LED gibi daha fazla ekipman gerektirir.`,onboardingQ4:`Aydınlatma sistemi tercihiniz nedir?`,onboardingQ4Opt1Label:`LED`,onboardingQ4Opt1Detail:`(enerji verimli, düşük ısı)`,onboardingQ4Opt2Label:`HPS`,onboardingQ4Opt2Detail:`(yüksek basınçlı sodyum)`,onboardingQ4Opt3Label:`Emin değilim`,onboardingQ4Opt3Detail:`öneri almak istiyorum`,onboardingQ4Tip1:`LED'ler uzun ömürlüdür ve farklı spektrumlara sahip modeller ile bitki gelişim evrelerine uygun ışık sunar.`,onboardingQ4Tip2:`HPS lambalar çiçeklenme döneminde yoğun ışık sağlar, ancak daha fazla ısı yayar ve enerji tüketimi yüksektir.`,onboardingQ4Tip3:`LED teknolojisi çoğu kullanıcı için başlangıç ve uzun vadede daha avantajlıdır; düşük ısı ve modüler tasarımıyla öne çıkar.`,onboardingQ5:`Otomasyon seviyeniz ne olacak?`,onboardingQ5Opt1Label:`Tamamen manuel`,onboardingQ5Opt1Detail:`(sulama, ışık kontrolü vb.)`,onboardingQ5Opt2Label:`Yarı otomatik`,onboardingQ5Opt2Detail:`(zamanlayıcı, fan kontrolü)`,onboardingQ5Opt3Label:`Tam otomatik`,onboardingQ5Opt3Detail:`(iklim kontrolü, nem, sulama)`,onboardingQ5Tip1:`Manuel sistemler düşük bütçelidir ama dikkat gerektirir; günlük kontroller ihmal edilmemelidir.`,onboardingQ5Tip2:`Basit zamanlayıcılar ve sensör destekli fanlar verimliliği artırır ve hata payını azaltır.`,onboardingQ5Tip3:`Tam otomasyon, verim artışı sağlar ancak başlangıç maliyeti yüksektir; ileri düzey kullanıcılar için idealdir.`}};var Dr=(0,b.createContext)();const Or={USD:{symbol:`$`,rate:1},EUR:{symbol:`€`,rate:.92},TRY:{symbol:`₺`,rate:32.5}};var kr=()=>(navigator.language||navigator.userLanguage).toLowerCase().startsWith(`tr`)?`tr`:`en`,Ar=()=>localStorage.getItem(`language`)||kr(),jr=()=>localStorage.getItem(`currency`)||(Ar()===`tr`?`TRY`:`USD`),Mr=()=>localStorage.getItem(`unitSystem`)||(Ar()===`tr`?`METRIC`:`IMPERIAL`);function Nr({children:e}){let[t,n]=(0,b.useState)(Ar),[r,i]=(0,b.useState)(jr),[a,o]=(0,b.useState)(Mr),s=e=>{n(e),localStorage.setItem(`language`,e),e===`tr`?(c(`TRY`),l(`METRIC`)):e===`en`&&(c(`USD`),l(`IMPERIAL`))},c=e=>{i(e),localStorage.setItem(`currency`,e),e===`EUR`||e===`TRY`?l(`METRIC`):e===`USD`&&l(`IMPERIAL`)},l=e=>{o(e),localStorage.setItem(`unitSystem`,e)};return(0,P.jsx)(Dr.Provider,{value:{language:t,setLanguage:s,currency:r,setCurrency:c,unitSystem:a,setUnitSystem:l,t:(e,n={})=>{let r=Er[t][e]||e;return Object.keys(n).forEach(e=>{r=r.replace(`{${e}}`,n[e])}),r},formatPrice:e=>{let{symbol:t,rate:n}=Or[r];return`${t}${(e*n).toFixed(2)}`},formatUnit:(e,t=`length`)=>a===`IMPERIAL`?e:t===`length`?(e*30.48).toFixed(0):t===`area`?(e*.0929).toFixed(2):t===`volume`?(e*.0283).toFixed(2):e,getUnitLabel:(e=`length`)=>{if(a===`IMPERIAL`){if(e===`length`)return`ft`;if(e===`area`)return`sq ft`;if(e===`volume`)return`cu ft`}else{if(e===`length`)return`cm`;if(e===`area`)return`m²`;if(e===`volume`)return`m³`}},getBuilderUrl:()=>t===`tr`?`/buyume-cadiri-kurulum-olusturucu`:`/grow-tent-setup-builder`},children:e})}function F(){return(0,b.useContext)(Dr)}var Pr=(0,b.createContext)();const Fr=()=>{let e=(0,b.useContext)(Pr);if(!e)throw Error(`useOnboarding must be used within OnboardingProvider`);return e},Ir=({children:e})=>{let[t,n]=(0,b.useState)(()=>{let e=localStorage.getItem(`onboardingData`);return e?JSON.parse(e):{plantType:null,experienceLevel:null,tentSize:null,lightPreference:null,automationLevel:null,completed:!1}});return(0,b.useEffect)(()=>{localStorage.setItem(`onboardingData`,JSON.stringify(t))},[t]),(0,P.jsx)(Pr.Provider,{value:{onboardingData:t,updateOnboarding:(e,t)=>{n(n=>({...n,[e]:t}))},completeOnboarding:()=>{n(e=>({...e,completed:!0})),localStorage.setItem(`seenOnboarding`,`true`)},resetOnboarding:()=>{n({plantType:null,experienceLevel:null,tentSize:null,lightPreference:null,automationLevel:null,completed:!1}),localStorage.removeItem(`seenOnboarding`)},hasSeenOnboarding:()=>localStorage.getItem(`seenOnboarding`)===`true`},children:e})},Lr=[{id:1,slug:{en:`understanding-ppfd-key-to-massive-yields`,tr:`ppfd-anlamak-buyuk-verimler-icin-anahtar`},title:{en:`Understanding PPFD: The Key to Massive Yields`,tr:`PPFD'yi Anlamak: Büyük Verimler İçin Anahtar`},excerpt:{en:`Why lumens don't matter and how to measure the light your plants actually use for photosynthesis.`,tr:`Lümenlerin neden önemli olmadığını ve bitkilerinizin fotosentez için gerçekten kullandığı ışığı nasıl ölçeceğinizi öğrenin.`},category:`Lighting`,content:{en:`
      ...
      `})]})},Br=()=>{let{language:e,setLanguage:t,getBuilderUrl:n,t:r}=F(),i=Vt(),[a,o]=(0,b.useState)(!1),[s,c]=(0,b.useState)(!1),l=e=>i.pathname===e;return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`style`,{children:`
                .nav-wrapper {
                ...
                `}),(0,P.jsxs)(`nav`,{className:`nav-wrapper`,children:[(0,P.jsxs)(`div`,{className:`nav-container`,children:[(0,P.jsxs)(N,{to:`/`,className:`nav-logo`,children:[`🌱 `,(0,P.jsx)(`span`,{className:`nav-logo-text`,children:`GroWizard`})]}),(0,P.jsxs)(`div`,{className:`nav-links`,children:[(0,P.jsx)(N,{to:`/`,className:`nav-link ${l(`/`)?`active`:``}`,children:r(`navHome`)}),(0,P.jsxs)(`div`,{className:`dropdown-container`,onMouseEnter:()=>o(!0),onMouseLeave:()=>o(!1),children:[(0,P.jsxs)(`span`,{className:`nav-link ${i.pathname.includes(`/tools`)?`active`:``}`,children:[r(`navTools`),` ▾`]}),a&&(0,P.jsxs)(`div`,{className:`dropdown-menu`,children:[(0,P.jsx)(N,{to:`/tools/electricity-cost-calculator`,className:`dropdown-item`,children:r(`navCostCalc`)}),(0,P.jsx)(N,{to:`/tools/co2-calculator`,className:`dropdown-item`,children:r(`navCo2Calc`)}),(0,P.jsx)(N,{to:`/tools/unit-converter`,className:`dropdown-item`,children:r(`navUnitConv`)}),(0,P.jsx)(N,{to:`/tools/ppfd-heatmap`,className:`dropdown-item`,children:r(`navPpfdTool`)})]})]}),(0,P.jsx)(N,{to:`/blog`,className:`nav-link ${l(`/blog`)?`active`:``}`,children:r(`navBlog`)})]}),(0,P.jsxs)(`div`,{className:`nav-right`,children:[(0,P.jsx)(`button`,{onClick:()=>t(e===`en`?`tr`:`en`),className:`lang-btn`,children:e===`en`?`TR`:`EN`}),(0,P.jsx)(N,{to:n(),className:`cta-button`,children:r(`navBuilder`)})]}),(0,P.jsx)(`button`,{className:`hamburger`,onClick:()=>c(!s),children:s?`✕`:`☰`})]}),s&&(0,P.jsxs)(`div`,{className:`mobile-menu`,children:[(0,P.jsx)(N,{to:`/`,className:`mobile-link ${l(`/`)?`active`:``}`,onClick:()=>c(!1),children:r(`navHome`)}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`div`,{className:`mobile-link`,style:{opacity:.7},children:r(`navTools`)}),(0,P.jsxs)(`div`,{className:`mobile-tools`,children:[(0,P.jsx)(N,{to:`/tools/electricity-cost-calculator`,className:`mobile-link`,onClick:()=>c(!1),children:r(`navCostCalc`)}),(0,P.jsx)(N,{to:`/tools/co2-calculator`,className:`mobile-link`,onClick:()=>c(!1),children:r(`navCo2Calc`)}),(0,P.jsx)(N,{to:`/tools/unit-converter`,className:`mobile-link`,onClick:()=>c(!1),children:r(`navUnitConv`)}),(0,P.jsx)(N,{to:`/tools/ppfd-heatmap`,className:`mobile-link`,onClick:()=>c(!1),children:r(`navPpfdTool`)})]})]}),(0,P.jsx)(N,{to:`/blog`,className:`mobile-link ${l(`/blog`)?`active`:``}`,onClick:()=>c(!1),children:r(`navBlog`)}),(0,P.jsxs)(`div`,{className:`mobile-actions`,children:[(0,P.jsx)(`button`,{onClick:()=>{t(e===`en`?`tr`:`en`),c(!1)},className:`lang-btn`,children:r(e===`en`?`switchToTr`:`switchToEn`)}),(0,P.jsx)(N,{to:n(),className:`cta-button`,onClick:()=>c(!1),children:r(`navBuilder`)})]})]})]})]})};function Vr(){let[e,t]=(0,b.useState)({x:0,y:0}),[n,r]=(0,b.useState)(0),[i,a]=(0,b.useState)(!1),[,o]=(0,b.useState)(0),{hasSeenOnboarding:s}=Fr(),{language:c,getBuilderUrl:l,t:u}=F(),d=Wt(),f=[{icon:`💡`,titleKey:`landingInfoLight`,descKey:`landingInfoLightDesc`},{icon:`🌬️`,titleKey:`landingInfoAir`,descKey:`landingInfoAirDesc`},{icon:`🌡️`,titleKey:`landingInfoHumidity`,descKey:`landingInfoHumidityDesc`}],p=c===`en`?[{q:`Why do plants need light?`,a:`To perform photosynthesis.`},{q:`Why is photosynthesis important?`,a:`Plants produce their food this way.`},{q:`Which plants are suitable for indoor growing?`,a:`Herbs, vegetables, flowers.`},{q:`What happens if I don't install a fan in my grow tent?`,a:`Temperature rises, mold forms.`},{q:`How many hours of light per day during vegetative stage?`,a:`16 hours is generally sufficient.`},{q:`How many hours of light per day during flowering stage?`,a:`12 hours is generally sufficient.`},{q:`Why LED lights?`,a:`Efficient, cool, and long-lasting.`},{q:`How long does germination typically take?`,a:`Usually 3 to 10 days.`},{q:`What should humidity be in the tent during vegetative stage?`,a:`50–70% is ideal.`}]:[{q:`Bitkiler neden yapay ışığa ihtiyaç duyar?`,a:`Bitkiler büyümek, gelişmek ve enerji üretmek için fotosentez yapar. İç mekan yetiştiriciliğinde doğal güneş ışığı yeterli olmadığından yapay aydınlatma (özellikle LED grow ışıkları) kullanılır.`},{q:`Fotosentez neden bitki sağlığı için kritiktir?`,a:`Fotosentez, bitkilerin su ve karbondioksiti güneş (veya yapay) ışığı ile şekere dönüştürmesini sağlar. Bu süreç, bitkinin enerji kaynağını oluşturur ve sağlıklı gelişimi mümkün kılar.`},{q:`İç mekanda hangi bitki türleri yetiştirilebilir?`,a:`Aromatik otlar (fesleğen, nane), yapraklı sebzeler (marul, ıspanak) ve bazı çiçekli türler (orkide, sardunya) iç mekan yetiştiriciliğine uygundur. Bu bitkiler sınırlı alanda, kontrollü iklim şartlarında iyi sonuç verir.`},{q:`Fan olmayan yetiştirme kabininde ne olur?`,a:`Fan kullanılmayan kabinlerde hava dolaşımı olmaz, bu da sıcaklık artışına ve nem birikmesine neden olur. Sonuç olarak mantar oluşumu, küf ve bitki hastalıkları riski yükselir.`},{q:`Büyüme döneminde bitkiye günde kaç saat ışık verilmeli?`,a:`Büyüme (vejetatif) aşamasında çoğu bitki 16–18 saatlik ışık süresine ihtiyaç duyar. Bu süre, yaprak gelişimini ve sağlıklı gövde oluşumunu destekler.`},{q:`Çiçeklenme döneminde ışık süresi ne olmalı?`,a:`Çiçeklenme döneminde fotoperiyodik bitkiler için 12 saat ışık, 12 saat karanlık döngüsü uygulanmalıdır. Bu denge, çiçek ve meyve oluşumunu teşvik eder.`},{q:`LED grow ışıklarının avantajı nedir?`,a:`LED bitki lambaları, düşük enerji tüketimi, uzun ömür ve minimal ısı yayımı ile ideal iç mekan aydınlatması sunar. Ayrıca, bitki evresine uygun tam spektrum ışık sağlayabilir.`},{q:`Tohumlar çimlenme döneminde kaç günde filizlenir?`,a:`Çimlenme süresi bitki türüne bağlı olmakla birlikte genellikle 3 ila 10 gün arasında tamamlanır. Bu dönemde nemli ortam ve sabit sıcaklık sağlanmalıdır.`},{q:`Büyüme döneminde çadır içi nem oranı ne olmalı?`,a:`Vejetatif büyüme aşamasında ideal nem oranı %50 ila %70 aralığındadır. Bu nem seviyesi, yaprakların su kaybını dengeleyerek hızlı gelişimi destekler.`}];return(0,b.useEffect)(()=>{let e=e=>{t({x:e.clientX/window.innerWidth-.5,y:e.clientY/window.innerHeight-.5})},n=()=>{o(window.scrollY),a(window.scrollY>300)};return window.addEventListener(`mousemove`,e),window.addEventListener(`scroll`,n),()=>{window.removeEventListener(`mousemove`,e),window.removeEventListener(`scroll`,n)}},[]),(0,P.jsxs)(`div`,{className:`landing-container`,children:[(0,P.jsxs)(Re,{children:[(0,P.jsxs)(`title`,{children:[u(`landingTitle`),` | GroWizard`]}),(0,P.jsx)(`meta`,{name:`description`,content:u(`landingSubtitle`)})]}),(0,P.jsxs)(`div`,{className:`landing-bg`,children:[(0,P.jsx)(`div`,{className:`glow-orb orb-1`,style:{transform:`translate(${e.x*30}px, ${e.y*30}px)`}}),(0,P.jsx)(`div`,{className:`glow-orb orb-2`,style:{transform:`translate(${e.x*-30}px, ${e.y*-30}px)`}}),(0,P.jsx)(`div`,{className:`grid-overlay`})]}),(0,P.jsx)(Br,{}),(0,P.jsxs)(`section`,{className:`hero-section`,children:[(0,P.jsxs)(`div`,{className:`hero-content fade-in-up`,children:[(0,P.jsx)(`div`,{className:`badge`,children:u(`landingBadge`)}),(0,P.jsxs)(`h1`,{className:`hero-title`,children:[u(`landingTitle`).split(` `).slice(0,2).join(` `),` `,(0,P.jsx)(`br`,{}),(0,P.jsx)(`span`,{className:`gradient-text`,children:u(`landingTitle`).split(` `).slice(2).join(` `)})]}),(0,P.jsx)(`p`,{className:`hero-subtitle`,children:u(`landingSubtitle`)}),(0,P.jsxs)(`button`,{onClick:()=>{d(l())},className:`cta-button`,children:[u(`landingCta`),(0,P.jsx)(`span`,{className:`arrow`,children:`→`})]})]}),(0,P.jsx)(`div`,{className:`hero-visual`,style:{transform:`perspective(1000px) rotateY(${e.x*5}deg) rotateX(${e.y*-5}deg)`},children:(0,P.jsxs)(`div`,{className:`tent-frame`,children:[(0,P.jsx)(`div`,{className:`plant-icon`,children:`🌿`}),(0,P.jsx)(`div`,{className:`light-beam`})]})})]}),(0,P.jsxs)(`section`,{className:`tools-preview-section`,children:[(0,P.jsxs)(`div`,{className:`section-header`,children:[(0,P.jsxs)(`h2`,{children:[`🛠️ `,u(`landingGrowTools`)]}),(0,P.jsx)(`p`,{children:u(`landingGrowToolsSubtitle`)})]}),(0,P.jsxs)(`div`,{className:`tools-grid`,children:[(0,P.jsxs)(N,{to:`/tools/cost-calculator`,className:`tool-preview-card`,children:[(0,P.jsx)(`div`,{className:`tool-icon`,children:`⚡`}),(0,P.jsx)(`h3`,{children:u(`landingCostCalculator`)}),(0,P.jsx)(`p`,{children:u(`landingCostCalculatorDesc`)})]}),(0,P.jsxs)(N,{to:`/tools/unit-converter`,className:`tool-preview-card`,children:[(0,P.jsx)(`div`,{className:`tool-icon`,children:`💧`}),(0,P.jsx)(`h3`,{children:u(`landingUnitConverter`)}),(0,P.jsx)(`p`,{children:u(`landingUnitConverterDesc`)})]}),(0,P.jsxs)(N,{to:`/tools/co2-calculator`,className:`tool-preview-card`,children:[(0,P.jsx)(`div`,{className:`tool-icon`,children:`🌫️`}),(0,P.jsx)(`h3`,{children:u(`landingCo2Calculator`)}),(0,P.jsx)(`p`,{children:u(`landingCo2CalculatorDesc`)})]})]}),(0,P.jsx)(`div`,{className:`center-btn`,children:(0,P.jsx)(N,{to:`/tools`,className:`secondary-btn`,children:u(`landingViewAllTools`)})})]}),(0,P.jsxs)(`section`,{className:`features-section`,children:[(0,P.jsxs)(`div`,{className:`feature-card slide-in`,style:{transitionDelay:`0.1s`},children:[(0,P.jsx)(`div`,{className:`feature-icon`,children:`💡`}),(0,P.jsx)(`h3`,{children:u(`landingPpfdTitle`)}),(0,P.jsx)(`p`,{children:u(`landingPpfdDesc`)})]}),(0,P.jsxs)(`div`,{className:`feature-card slide-in`,style:{transitionDelay:`0.3s`},children:[(0,P.jsx)(`div`,{className:`feature-icon`,children:`🌬️`}),(0,P.jsx)(`h3`,{children:u(`landingEnvTitle`)}),(0,P.jsx)(`p`,{children:u(`landingEnvDesc`)})]})]}),(0,P.jsxs)(`section`,{className:`info-boxes-section`,children:[(0,P.jsxs)(`div`,{className:`info-boxes-header`,children:[(0,P.jsxs)(`h2`,{children:[`⚠️ `,u(`landingInfoTitle`)]}),(0,P.jsx)(`p`,{children:u(`landingInfoSubtitle`)})]}),(0,P.jsx)(`div`,{className:`info-boxes-container`,children:f.map((e,t)=>(0,P.jsxs)(`div`,{className:`info-box`,style:{animationDelay:`${t*.1}s`},children:[(0,P.jsx)(`div`,{className:`info-box-icon`,children:e.icon}),(0,P.jsxs)(`div`,{className:`info-box-content`,children:[(0,P.jsx)(`h3`,{children:u(e.titleKey)}),(0,P.jsx)(`p`,{children:u(e.descKey)})]})]},t))})]}),(0,P.jsxs)(`section`,{className:`featured-guides-section`,children:[(0,P.jsxs)(`div`,{className:`section-header`,children:[(0,P.jsxs)(`h2`,{children:[`🌟 `,u(`landingFeaturedGuides`)]}),(0,P.jsx)(`p`,{children:u(`landingFeaturedGuidesSubtitle`)})]}),(0,P.jsxs)(`div`,{className:`slider-container`,children:[(0,P.jsx)(`button`,{className:`slider-btn prev`,onClick:()=>r(e=>e===0?Math.ceil(Lr.length/2)-1:e-1),children:`←`}),(0,P.jsx)(`div`,{className:`slider-track-container`,children:(0,P.jsx)(`div`,{className:`slider-track`,style:{transform:`translateX(-${n*100}%)`},children:Array.from({length:Math.ceil(Lr.slice(0,4).length/2)}).map((e,t)=>(0,P.jsx)(`div`,{className:`slider-slide`,children:Lr.slice(0,4).slice(t*2,t*2+2).map(e=>(0,P.jsxs)(N,{to:`/blog/${e.slug[c]}`,className:`featured-guide-card`,children:[(0,P.jsxs)(`div`,{className:`guide-content`,children:[(0,P.jsx)(`span`,{className:`guide-tag`,children:e.category}),(0,P.jsx)(`h3`,{children:e.title[c]}),(0,P.jsx)(`p`,{children:e.excerpt[c]}),(0,P.jsx)(`span`,{className:`read-more`,children:u(`landingReadMore`)})]}),(0,P.jsx)(`div`,{className:`guide-image`,style:{backgroundImage:`url(${e.image})`}})]},`featured-${e.id}`))},t))})}),(0,P.jsx)(`button`,{className:`slider-btn next`,onClick:()=>r(e=>e===Math.ceil(Lr.slice(0,4).length/2)-1?0:e+1),children:`→`})]}),(0,P.jsx)(`div`,{className:`slider-dots`,children:Array.from({length:Math.ceil(Lr.slice(0,4).length/2)}).map((e,t)=>(0,P.jsx)(`button`,{className:`slider-dot ${n===t?`active`:``}`,onClick:()=>r(t)},t))})]}),(0,P.jsx)(`section`,{className:`cost-tool-section`,children:(0,P.jsxs)(`div`,{className:`cost-tool-container`,children:[(0,P.jsxs)(`div`,{className:`cost-tool-header`,children:[(0,P.jsxs)(`h2`,{children:[`⚡ `,u(`landingCostToolTitle`)]}),(0,P.jsx)(`p`,{children:u(`landingCostToolSubtitle`)})]}),(0,P.jsxs)(`div`,{className:`cost-tool-inputs`,children:[(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:u(`landingCostToolPower`)}),(0,P.jsx)(`input`,{type:`number`,id:`power-input`,placeholder:`300`,defaultValue:`300`})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:u(`landingCostToolHours`)}),(0,P.jsx)(`input`,{type:`number`,id:`hours-input`,placeholder:`18`,defaultValue:`18`})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:u(`landingCostToolRate`)}),(0,P.jsx)(`input`,{type:`number`,step:`0.01`,id:`rate-input`,placeholder:`0.12`,defaultValue:`0.12`})]})]}),(0,P.jsx)(`button`,{className:`calc-button`,onClick:()=>{let e=parseFloat(document.getElementById(`power-input`).value)||0,t=parseFloat(document.getElementById(`hours-input`).value)||0,n=parseFloat(document.getElementById(`rate-input`).value)||0,r=e/1e3*t*30*n;document.getElementById(`cost-result`).textContent=`${u(`landingCostToolResult`)}: ${c===`tr`?`₺`:`$`}${r.toFixed(2)}`},children:u(`landingCostToolCalculate`)}),(0,P.jsxs)(`div`,{className:`cost-result`,id:`cost-result`,children:[u(`landingCostToolResult`),`: `,c===`tr`?`₺`:`$`,`0.00`]})]})}),(0,P.jsxs)(`section`,{className:`faq-section`,children:[(0,P.jsxs)(`div`,{className:`section-header`,children:[(0,P.jsxs)(`h2`,{children:[`❓ `,u(`landingFaqTitle`)]}),(0,P.jsx)(`p`,{children:u(`landingFaqSubtitle`)})]}),(0,P.jsx)(`div`,{className:`faq-grid`,children:p.map((e,t)=>(0,P.jsxs)(`div`,{className:`faq-item`,children:[(0,P.jsx)(`h3`,{children:e.q}),(0,P.jsx)(`p`,{children:e.a})]},t))})]}),(0,P.jsxs)(`section`,{className:`blog-preview-section`,children:[(0,P.jsxs)(`div`,{className:`blog-preview-header`,children:[(0,P.jsxs)(`h2`,{children:[`📚 `,u(`landingLatestArticles`)]}),(0,P.jsx)(`p`,{children:u(`landingLatestArticlesSubtitle`)})]}),(0,P.jsx)(`div`,{className:`blog-preview-grid`,children:Lr.slice(0,3).map(e=>(0,P.jsxs)(N,{to:`/blog/${e.slug[c]}`,className:`blog-preview-card`,children:[(0,P.jsx)(`div`,{className:`preview-image`,style:{backgroundImage:`url(${e.image})`}}),(0,P.jsxs)(`div`,{className:`preview-content`,children:[(0,P.jsx)(`span`,{className:`preview-tag`,children:e.category}),(0,P.jsx)(`h3`,{children:e.title[c]}),(0,P.jsxs)(`div`,{className:`preview-meta`,children:[(0,P.jsx)(`span`,{children:e.readTime}),(0,P.jsx)(`span`,{className:`arrow`,children:`→`})]})]})]},e.id))}),(0,P.jsx)(`div`,{className:`blog-cta`,children:(0,P.jsx)(N,{to:`/blog`,className:`view-all-btn`,children:u(`landingViewAllArticles`)})})]}),(0,P.jsx)(zr,{}),(0,P.jsx)(`button`,{className:`scroll-to-top ${i?`visible`:``}`,onClick:()=>{window.scrollTo({top:0,behavior:`smooth`})},"aria-label":`Scroll to top`,children:`↑`}),(0,P.jsx)(`style`,{children:`
                .landing-container {
                    min-height: 100vh;
                    background: #0a0a0a;
                    color: white;
            ...
            `})]})}function Hr(){let[e,t]=(0,b.useState)(1),[n,r]=(0,b.useState)(!1),{onboardingData:i,updateOnboarding:a,completeOnboarding:o}=Fr(),{getBuilderUrl:s,t:c}=F(),l=Wt(),u=[{questionKey:`onboardingQ1`,field:`plantType`,options:[{value:`herbs`,labelKey:`onboardingQ1Opt1Label`,detailKey:`onboardingQ1Opt1Detail`,icon:`🌿`},{value:`vegetables`,labelKey:`onboardingQ1Opt2Label`,detailKey:`onboardingQ1Opt2Detail`,icon:`🥬`},{value:`flowers`,labelKey:`onboardingQ1Opt3Label`,detailKey:`onboardingQ1Opt3Detail`,icon:`🌺`}],tooltips:{herbs:`onboardingQ1Tip1`,vegetables:`onboardingQ1Tip2`,flowers:`onboardingQ1Tip3`}},{questionKey:`onboardingQ2`,field:`experienceLevel`,options:[{value:`beginner`,labelKey:`onboardingQ2Opt1Label`,icon:`🌱`},{value:`intermediate`,labelKey:`onboardingQ2Opt2Label`,icon:`🌿`},{value:`expert`,labelKey:`onboardingQ2Opt3Label`,icon:`🏆`}],tooltips:{beginner:`onboardingQ2Tip1`,intermediate:`onboardingQ2Tip2`,expert:`onboardingQ2Tip3`}},{questionKey:`onboardingQ3`,field:`tentSize`,options:[{value:`60x60`,labelKey:`onboardingQ3Opt1Label`,detailKey:`onboardingQ3Opt1Detail`,icon:`📦`},{value:`100x100`,labelKey:`onboardingQ3Opt2Label`,detailKey:`onboardingQ3Opt2Detail`,icon:`📦`},{value:`120x120`,labelKey:`onboardingQ3Opt3Label`,detailKey:`onboardingQ3Opt3Detail`,icon:`📦`}],tooltips:{"60x60":`onboardingQ3Tip1`,"100x100":`onboardingQ3Tip2`,"120x120":`onboardingQ3Tip3`}},{questionKey:`onboardingQ4`,field:`lightPreference`,options:[{value:`led`,labelKey:`onboardingQ4Opt1Label`,detailKey:`onboardingQ4Opt1Detail`,icon:`💡`},{value:`hps`,labelKey:`onboardingQ4Opt2Label`,detailKey:`onboardingQ4Opt2Detail`,icon:`🔥`},{value:`unsure`,labelKey:`onboardingQ4Opt3Label`,detailKey:`onboardingQ4Opt3Detail`,icon:`❓`}],tooltips:{led:`onboardingQ4Tip1`,hps:`onboardingQ4Tip2`,unsure:`onboardingQ4Tip3`}},{questionKey:`onboardingQ5`,field:`automationLevel`,options:[{value:`manual`,labelKey:`onboardingQ5Opt1Label`,detailKey:`onboardingQ5Opt1Detail`,icon:`✋`},{value:`semi`,labelKey:`onboardingQ5Opt2Label`,detailKey:`onboardingQ5Opt2Detail`,icon:`⚙️`},{value:`full`,labelKey:`onboardingQ5Opt3Label`,detailKey:`onboardingQ5Opt3Detail`,icon:`🤖`}],tooltips:{manual:`onboardingQ5Tip1`,semi:`onboardingQ5Tip2`,full:`onboardingQ5Tip3`}}],d=u[e-1],f=e/u.length*100,[p,m]=(0,b.useState)(``),h=e=>{a(d.field,e),m(c(d.tooltips[e])),r(!0)},g=()=>{r(!1),e<u.length?t(e+1):(o(),l(s()))};return b.useEffect(()=>{if(n){let e=setTimeout(()=>{g()},1e4);return()=>clearTimeout(e)}},[n]),(0,P.jsxs)(`div`,{className:`onboarding-container`,children:[(0,P.jsxs)(`div`,{className:`onboarding-bg`,children:[(0,P.jsx)(`div`,{className:`glow-orb orb-green`}),(0,P.jsx)(`div`,{className:`grid-overlay`})]}),(0,P.jsxs)(`div`,{className:`onboarding-content`,children:[(0,P.jsxs)(`div`,{className:`progress-container`,children:[(0,P.jsx)(`div`,{className:`progress-bar`,style:{width:`${f}%`}}),(0,P.jsxs)(`span`,{className:`progress-text`,children:[c(`onboardingStep`),` `,e,` / `,u.length]})]}),(0,P.jsxs)(`div`,{className:`question-container fade-in`,children:[(0,P.jsx)(`h2`,{className:`question-title`,children:c(d.questionKey)}),(0,P.jsx)(`div`,{className:`options-grid`,children:d.options.map(e=>(0,P.jsxs)(`button`,{onClick:()=>h(e.value),className:`option-card ${i[d.field]===e.value?`selected`:``}`,children:[(0,P.jsx)(`span`,{className:`option-icon`,children:e.icon}),(0,P.jsxs)(`div`,{className:`option-text`,children:[(0,P.jsx)(`span`,{className:`option-label`,children:c(e.labelKey)}),e.detailKey&&(0,P.jsx)(`span`,{className:`option-detail`,children:c(e.detailKey)})]})]},e.value))}),n&&(0,P.jsxs)(`div`,{className:`tooltip-box fade-in`,children:[(0,P.jsx)(`p`,{children:p}),(0,P.jsx)(`button`,{onClick:g,className:`btn-continue`,children:c(`onboardingContinue`)})]})]}),(0,P.jsxs)(`div`,{className:`nav-buttons`,children:[e>1&&(0,P.jsx)(`button`,{onClick:()=>{e>1&&(t(e-1),r(!1))},className:`btn-secondary`,children:c(`onboardingBack`)}),(0,P.jsx)(`button`,{onClick:()=>{o(),l(s())},className:`btn-skip`,children:c(`onboardingSkip`)})]})]}),(0,P.jsx)(`style`,{children:`
      ...
      `})]}):(0,P.jsxs)(`div`,{className:`not-found-container`,children:[(0,P.jsx)(Br,{}),(0,P.jsx)(`h2`,{children:e===`tr`?`Yazı Bulunamadı`:`Post Not Found`}),(0,P.jsx)(`p`,{children:e===`tr`?`Aradığınız makale mevcut değil veya taşınmış.`:`The article you're looking for doesn't exist or has been moved.`}),(0,P.jsx)(N,{to:`/blog`,className:`back-btn`,children:e===`tr`?`Bloga Dön`:`Back to Blog`})]})},Pi=()=>{let{t:e}=F();return(0,P.jsxs)(`div`,{className:`page-container`,children:[(0,P.jsx)(Br,{}),(0,P.jsxs)(`div`,{className:`tools-content`,children:[(0,P.jsxs)(`div`,{className:`tools-header`,children:[(0,P.jsx)(`h1`,{children:e(`toolsTitle`)}),(0,P.jsx)(`p`,{children:e(`toolsSubtitle`)})]}),(0,P.jsx)(`div`,{className:`tools-grid`,children:[{id:`cost`,icon:`⚡`,titleKey:`toolCostTitle`,descKey:`toolCostDesc`,path:`/tools/electricity-cost-calculator`,color:`from-yellow-400 to-orange-500`},{id:`unit`,icon:`💧`,titleKey:`toolUnitTitle`,descKey:`toolUnitDesc`,path:`/tools/unit-converter`,color:`from-blue-400 to-cyan-500`},{id:`co2`,icon:`🌫️`,titleKey:`toolCo2Title`,descKey:`toolCo2Desc`,path:`/tools/co2-calculator`,color:`from-gray-400 to-gray-600`},{id:`ppfd`,icon:`🌡️`,titleKey:`toolPpfdTitle`,descKey:`toolPpfdDesc`,path:`/tools/ppfd-heatmap`,color:`from-red-400 to-red-600`}].map(t=>(0,P.jsxs)(N,{to:t.path,className:`tool-card`,children:[(0,P.jsx)(`div`,{className:`card-icon`,children:t.icon}),(0,P.jsx)(`h3`,{children:e(t.titleKey)}),(0,P.jsx)(`p`,{children:e(t.descKey)}),(0,P.jsx)(`div`,{className:`card-arrow`,children:`→`})]},t.id))})]}),(0,P.jsx)(zr,{}),(0,P.jsx)(`style`,{children:`
                .page-container {
                    min-height: 100vh;
                    background: #0a0a0a;
                    color: white;
            ...
            `})]})},Fi=()=>{let{language:e,t}=F(),[n,r]=(0,b.useState)(200),[i,a]=(0,b.useState)(18),[o,s]=(0,b.useState)(0),[c,l]=(0,b.useState)(.12),u=n*(i+o/60)/1e3,d=u*c,f=[t(`costCalcIntroStep1`),t(`costCalcIntroStep2`)],p=[t(`costCalcWorksList1`),t(`costCalcWorksList2`),t(`costCalcWorksList3`),t(`costCalcWorksList4`)],m=[t(`costCalcTip1`),t(`costCalcTip2`),t(`costCalcTip3`),t(`costCalcTip4`),t(`costCalcTip5`),t(`costCalcTip6`),t(`costCalcTip7`),t(`costCalcTip8`),t(`costCalcTip9`),t(`costCalcTip10`),t(`costCalcTip11`)],h=[{q:t(`costCalcFaq1Q`),a:t(`costCalcFaq1A`)},{q:t(`costCalcFaq2Q`),a:t(`costCalcFaq2A`)},{q:t(`costCalcFaq3Q`),a:t(`costCalcFaq3A`)},{q:t(`costCalcFaq4Q`),a:t(`costCalcFaq4A`)}];return(0,P.jsxs)(`div`,{className:`page-container`,children:[(0,P.jsxs)(Re,{children:[(0,P.jsxs)(`title`,{children:[t(`costCalcTitle`),` | GroWizard`]}),(0,P.jsx)(`meta`,{name:`description`,content:t(`costCalcSubtitle`)})]}),(0,P.jsx)(Br,{}),(0,P.jsxs)(`div`,{className:`tool-content`,children:[(0,P.jsxs)(`div`,{className:`tool-card`,children:[(0,P.jsxs)(`div`,{className:`tool-header`,children:[(0,P.jsx)(`div`,{className:`tool-icon`,children:`⚡`}),(0,P.jsx)(`h1`,{children:t(`costCalcTitle`)}),(0,P.jsx)(`p`,{children:t(`costCalcSubtitle`)})]}),(0,P.jsxs)(`div`,{className:`calculator-form`,children:[(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsxs)(`div`,{className:`label-row`,children:[(0,P.jsx)(`label`,{children:t(`costCalcPower`)}),(0,P.jsx)(`span`,{className:`dots`,children:`•••`})]}),(0,P.jsxs)(`div`,{className:`input-wrapper`,children:[(0,P.jsx)(`input`,{type:`number`,value:n,onChange:e=>r(parseFloat(e.target.value)||0)}),(0,P.jsx)(`span`,{className:`unit`,children:t(`costCalcW`)}),(0,P.jsx)(`span`,{className:`arrow`,children:`⌄`})]})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsxs)(`div`,{className:`label-row`,children:[(0,P.jsx)(`label`,{children:t(`costCalcTime`)}),(0,P.jsx)(`span`,{className:`dots`,children:`•••`})]}),(0,P.jsxs)(`div`,{className:`input-wrapper time-wrapper`,children:[(0,P.jsxs)(`div`,{className:`time-input`,children:[(0,P.jsx)(`input`,{type:`number`,value:i,onChange:e=>a(parseFloat(e.target.value)||0)}),(0,P.jsx)(`span`,{className:`unit`,children:t(`costCalcHrs`)})]}),(0,P.jsx)(`span`,{className:`divider`,children:`|`}),(0,P.jsxs)(`div`,{className:`time-input`,children:[(0,P.jsx)(`input`,{type:`number`,value:o,onChange:e=>s(parseFloat(e.target.value)||0)}),(0,P.jsx)(`span`,{className:`unit`,children:t(`costCalcMin`)})]}),(0,P.jsx)(`span`,{className:`arrow`,children:`⌄`})]})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsxs)(`div`,{className:`label-row`,children:[(0,P.jsx)(`label`,{children:t(`costCalcEnergy`)}),(0,P.jsx)(`span`,{className:`dots`,children:`•••`})]}),(0,P.jsxs)(`div`,{className:`input-wrapper read-only`,children:[(0,P.jsx)(`span`,{className:`value highlight-blue`,children:u.toLocaleString(void 0,{maximumFractionDigits:2})}),(0,P.jsx)(`span`,{className:`unit highlight-blue`,children:t(`costCalcKwh`)})]})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsxs)(`div`,{className:`label-row`,children:[(0,P.jsx)(`label`,{children:t(`costCalcPrice`)}),(0,P.jsx)(`span`,{className:`pin`,children:`📌`}),(0,P.jsx)(`span`,{className:`dots`,children:`•••`})]}),(0,P.jsxs)(`div`,{className:`input-wrapper`,children:[(0,P.jsx)(`span`,{className:`currency-prefix`,children:t(`costCalcCurrency`)}),(0,P.jsx)(`input`,{type:`number`,value:c,step:`0.01`,onChange:e=>l(parseFloat(e.target.value)||0),className:`price-input`}),(0,P.jsxs)(`span`,{className:`unit-suffix`,children:[`/ `,t(`costCalcKwh`)]})]})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsxs)(`div`,{className:`label-row`,children:[(0,P.jsx)(`label`,{children:t(`costCalcCost`)}),(0,P.jsx)(`span`,{className:`dots`,children:`•••`})]}),(0,P.jsxs)(`div`,{className:`input-wrapper read-only cost-wrapper`,children:[(0,P.jsx)(`span`,{className:`currency-prefix highlight-blue`,children:t(`costCalcCurrency`)}),(0,P.jsx)(`span`,{className:`value highlight-blue`,children:d.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:3})})]})]})]})]}),(0,P.jsxs)(`div`,{className:`info-section`,children:[(0,P.jsx)(`h2`,{children:t(`costCalcIntroTitle`)}),(0,P.jsx)(`p`,{children:t(`costCalcIntroText`)}),(0,P.jsx)(`ul`,{children:f.map((e,t)=>(0,P.jsx)(`li`,{children:e},t))}),(0,P.jsx)(`p`,{className:`example`,children:t(`costCalcIntroExample`)}),(0,P.jsx)(`h2`,{children:t(`costCalcWorksTitle`)}),(0,P.jsx)(`p`,{children:t(`costCalcWorksText`)}),(0,P.jsx)(`ol`,{children:p.map((e,t)=>(0,P.jsx)(`li`,{children:e},t))}),(0,P.jsx)(`h2`,{children:t(`costCalcTipsTitle`)}),(0,P.jsx)(`ul`,{className:`tips-list`,children:m.map((e,t)=>(0,P.jsxs)(`li`,{children:[`✅ `,e]},t))}),(0,P.jsx)(`h2`,{children:t(`costCalcFaqTitle`)}),(0,P.jsx)(`div`,{className:`faq-list`,children:h.map((e,t)=>(0,P.jsxs)(`div`,{className:`faq-item`,children:[(0,P.jsx)(`h3`,{children:e.q}),(0,P.jsx)(`p`,{children:e.a})]},t))})]})]}),(0,P.jsx)(zr,{}),(0,P.jsx)(`style`,{children:`
                .page-container {
                    min-height: 100vh;
                    background: #0a0a0a;
                    color: white;
            ...
            `})]})},Ii=()=>{let{t:e}=F(),[t,n]=(0,b.useState)(1),r={ml:.001,l:1,gal:3.78541,qt:.946353,pt:.473176,cup:.236588,floz:.0295735,tbsp:.0147868,tsp:.00492892,m3:1e3,ft3:28.3168},i=(e,t)=>{let i=parseFloat(t);isNaN(i)?t===``&&n(0):n(i*r[e])},a=e=>{let n=t/r[e];return n===0?``:parseFloat(n.toFixed(6))},o={ml:e(`unitConvMl`),l:e(`unitConvL`),gal:e(`unitConvGal`),qt:e(`unitConvQt`),pt:e(`unitConvPt`),cup:e(`unitConvCup`),floz:e(`unitConvFloz`),tbsp:e(`unitConvTbsp`),tsp:e(`unitConvTsp`),m3:e(`unitConvM3`),ft3:e(`unitConvFt3`)},s=[`cubic millimeters (mm³)*`,`cubic centimeters (cm³)*`,`cubic decimeters (dm³)*`,`cubic meters (m³)*`,`cubic inches (cu in)*`,`cubic feet (cu ft)*`,`cubic yards (cu yd)*`,`milliliters (ml)`,`liters (l)`,`gallons (US) / gallons (UK) (gal)`,`quarts (US) / quarts (UK) (qt)`,`pints (US) / pints (UK) (pt)`,`fluid ounces (US) / fluid ounces (UK) (fl oz)`,`US customary cups/glasses (236.59ml) (cups)`,`tablespoons (15 ml) (tablespoons)`,`teaspoons (5 ml) (teaspoons)`],c=[e(`unitConvChartMeasure`),e(`unitConvChartUS`),e(`unitConvChartMetric`)],l=[[`Teaspoon`,`4.93`,`5`],[`Tablespoon`,`14.79`,`15`],[`Fluid ounce`,`29.57`,`30`],[`Cup`,`236.59`,`250`],[`Pint`,`473.18`,`568.26 (UK)`],[`Quart`,`946.35`,`1136.52 (UK)`],[`Gallon`,`3785.41`,`4546.09 (UK)`]],u=[{q:e(`unitConvFaq1Q`),a:e(`unitConvFaq1A`)},{q:e(`unitConvFaq2Q`),a:e(`unitConvFaq2A`)},{q:e(`unitConvFaq3Q`),a:e(`unitConvFaq3A`)}];return(0,P.jsxs)(`div`,{className:`page-container`,children:[(0,P.jsx)(Br,{}),(0,P.jsxs)(`div`,{className:`tool-content`,children:[(0,P.jsxs)(`div`,{className:`tool-card`,children:[(0,P.jsxs)(`div`,{className:`tool-header`,children:[(0,P.jsx)(`div`,{className:`tool-icon`,children:`💧`}),(0,P.jsx)(`h1`,{children:e(`unitConvTitle`)}),(0,P.jsx)(`p`,{children:e(`unitConvSubtitle`)})]}),(0,P.jsx)(`div`,{className:`converter-grid`,children:[`ml`,`l`,`gal`,`qt`,`pt`,`cup`,`floz`,`tbsp`,`tsp`,`m3`,`ft3`].map(e=>(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:o[e]}),(0,P.jsx)(`input`,{type:`number`,value:a(e),onChange:t=>i(e,t.target.value),placeholder:`0`})]},e))})]}),(0,P.jsxs)(`div`,{className:`info-section`,children:[(0,P.jsx)(`h2`,{children:e(`unitConvIntroTitle`)}),(0,P.jsx)(`p`,{children:e(`unitConvIntroText`)}),(0,P.jsx)(`ul`,{children:s.map((e,t)=>(0,P.jsx)(`li`,{children:e},t))}),(0,P.jsx)(`p`,{className:`note`,children:e(`unitConvIntroNote`)}),(0,P.jsx)(`h2`,{children:e(`unitConvChartTitle`)}),(0,P.jsx)(`p`,{children:e(`unitConvChartText`)}),(0,P.jsx)(`div`,{className:`chart-container`,children:(0,P.jsxs)(`table`,{className:`conversion-table`,children:[(0,P.jsx)(`thead`,{children:(0,P.jsx)(`tr`,{children:c.map((e,t)=>(0,P.jsx)(`th`,{children:e},t))})}),(0,P.jsx)(`tbody`,{children:l.map((e,t)=>(0,P.jsx)(`tr`,{children:e.map((e,t)=>(0,P.jsx)(`td`,{children:e},t))},t))})]})}),(0,P.jsx)(`h2`,{children:e(`unitConvHowTitle`)}),(0,P.jsx)(`p`,{children:e(`unitConvHowText`)}),(0,P.jsx)(`h2`,{children:e(`unitConvFaqTitle`)}),(0,P.jsx)(`div`,{className:`faq-list`,children:u.map((e,t)=>(0,P.jsxs)(`div`,{className:`faq-item`,children:[(0,P.jsx)(`h3`,{children:e.q}),(0,P.jsx)(`p`,{children:e.a})]},t))})]})]}),(0,P.jsx)(zr,{}),(0,P.jsx)(`style`,{children:`
                .page-container {
                    min-height: 100vh;
                    background: #0a0a0a;
                    color: white;
            ...
            `})]})},Li=()=>{let{t:e}=F(),[t,n]=(0,b.useState)(120),[r,i]=(0,b.useState)(120),[a,o]=(0,b.useState)(200),[s,c]=(0,b.useState)(1200),[l,u]=(0,b.useState)(15),d=t*r*a/1e6,f=d*35.3147,p=f*Math.max(0,s-400)/1e6,m=p*28.3168,h=p/l,g=m/l,_=[e(`co2CalcHowList1`),e(`co2CalcHowList2`)],v=[{q:e(`co2CalcFaq1Q`),a:e(`co2CalcFaq1A`)},{q:e(`co2CalcFaq2Q`),a:e(`co2CalcFaq2A`)},{q:e(`co2CalcFaq3Q`),a:e(`co2CalcFaq3A`)}];return(0,P.jsxs)(`div`,{className:`page-container`,children:[(0,P.jsx)(Br,{}),(0,P.jsxs)(`div`,{className:`tool-content`,children:[(0,P.jsxs)(`div`,{className:`tool-card`,children:[(0,P.jsxs)(`div`,{className:`tool-header`,children:[(0,P.jsx)(`div`,{className:`tool-icon`,children:`🌫️`}),(0,P.jsx)(`h1`,{children:e(`co2CalcTitle`)}),(0,P.jsx)(`p`,{children:e(`co2CalcSubtitle`)})]}),(0,P.jsxs)(`div`,{className:`calculator-form`,children:[(0,P.jsx)(`div`,{className:`section-label`,children:e(`co2CalcDims`)}),(0,P.jsxs)(`div`,{className:`dims-grid`,children:[(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:`W (cm)`}),(0,P.jsx)(`input`,{type:`number`,value:t,onChange:e=>n(parseFloat(e.target.value)||0)})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:`L (cm)`}),(0,P.jsx)(`input`,{type:`number`,value:r,onChange:e=>i(parseFloat(e.target.value)||0)})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:`H (cm)`}),(0,P.jsx)(`input`,{type:`number`,value:a,onChange:e=>o(parseFloat(e.target.value)||0)})]})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:e(`co2CalcTarget`)}),(0,P.jsxs)(`div`,{className:`range-wrapper`,children:[(0,P.jsx)(`input`,{type:`range`,min:`400`,max:`2000`,step:`50`,value:s,onChange:e=>c(parseFloat(e.target.value)),className:`range-slider`}),(0,P.jsxs)(`span`,{className:`range-value`,children:[s,` PPM`]})]})]}),(0,P.jsxs)(`div`,{className:`input-group`,children:[(0,P.jsx)(`label`,{children:e(`co2CalcFillTime`)}),(0,P.jsxs)(`div`,{className:`range-wrapper`,children:[(0,P.jsx)(`input`,{type:`range`,min:`1`,max:`60`,step:`1`,value:l,onChange:e=>u(parseFloat(e.target.value)),className:`range-slider`}),(0,P.jsxs)(`span`,{className:`range-value`,children:[l,` min`]})]})]}),(0,P.jsxs)(`div`,{className:`results-grid`,children:[(0,P.jsxs)(`div`,{className:`result-item`,children:[(0,P.jsx)(`span`,{className:`label`,children:e(`co2CalcVolume`)}),(0,P.jsxs)(`span`,{className:`value`,children:[d.toFixed(2),` m³`]}),(0,P.jsxs)(`span`,{className:`sub-value`,children:[`(`,f.toFixed(2),` ft³)`]})]}),(0,P.jsxs)(`div`,{className:`result-item highlight`,children:[(0,P.jsx)(`span`,{className:`label`,children:e(`co2CalcRequired`)}),(0,P.jsxs)(`span`,{className:`value`,children:[p.toFixed(4),` ft³`]}),(0,P.jsxs)(`span`,{className:`sub-value`,children:[`(`,m.toFixed(2),` L)`]})]}),(0,P.jsxs)(`div`,{className:`result-item highlight-green`,children:[(0,P.jsx)(`span`,{className:`label`,children:e(`co2CalcFlow`)}),(0,P.jsxs)(`span`,{className:`value`,children:[g.toFixed(2),` L/min`]}),(0,P.jsxs)(`span`,{className:`sub-value`,children:[`(`,h.toFixed(4),` CFM)`]})]})]})]})]}),(0,P.jsxs)(`div`,{className:`info-section`,children:[(0,P.jsx)(`h2`,{children:e(`co2CalcIntroTitle`)}),(0,P.jsx)(`p`,{children:e(`co2CalcIntroText`)}),(0,P.jsx)(`p`,{children:e(`co2CalcIntroText2`)}),(0,P.jsx)(`h2`,{children:e(`co2CalcHowTitle`)}),(0,P.jsx)(`p`,{children:e(`co2CalcHowText`)}),(0,P.jsx)(`ul`,{children:_.map((e,t)=>(0,P.jsx)(`li`,{children:e},t))}),(0,P.jsx)(`p`,{children:e(`co2CalcHowText2`)}),(0,P.jsx)(`h2`,{children:e(`co2CalcFaqTitle`)}),(0,P.jsx)(`div`,{className:`faq-list`,children:v.map((e,t)=>(0,P.jsxs)(`div`,{className:`faq-item`,children:[(0,P.jsx)(`h3`,{children:e.q}),(0,P.jsx)(`p`,{children:e.a})]},t))})]})]}),(0,P.jsx)(zr,{}),(0,P.jsx)(`style`,{children:`
                .page-container {
                    min-height: 100vh;
                    background: #0a0a0a;
                    color: white;
            ...
            `})]})},zi=[{id:`l1`,name:`Quantum Board 100W`,maxPPFD:800,recommendedHeight:18,physicalWidth:1,physicalDepth:1,beamAngle:120},{id:`l2`,name:`Bar Light 600W`,maxPPFD:1600,recommendedHeight:24,physicalWidth:3.5,physicalDepth:3.5,beamAngle:120},{id:`l3`,name:`COB LED 200W`,maxPPFD:1200,recommendedHeight:20,physicalWidth:1.5,physicalDepth:1.5,beamAngle:90}];function Bi(){let{t:e}=F(),[t,n]=(0,b.useState)(`cm`),[r,i]=(0,b.useState)({width:150,depth:150,height:45}),[a,o]=(0,b.useState)([]),[s,c]=(0,b.useState)({average:0,min:0,max:0,uniformity:0}),l=(0,b.useRef)(null),u=(0,b.useRef)(null),[d,f]=(0,b.useState)(null),p=e=>{e!==t&&(i(t=>{let n=e===`cm`?30.48:1/30.48;return{width:parseFloat((t.width*n).toFixed(1)),depth:parseFloat((t.depth*n).toFixed(1)),height:parseFloat((t.height*n).toFixed(1))}}),n(e))},m=e=>{let t={...e,instanceId:Date.now(),positions:[{x:.5,y:.5,rotation:0}]};o([...a,t])},h=e=>{o(a.filter(t=>t.instanceId!==e))};(0,b.useEffect)(()=>{if(!u.current)return;let e=t===`cm`?r.width/30.48:r.width,n=t===`cm`?r.depth/30.48:r.depth,i=t===`cm`?r.height/30.48:r.height;if(!e||e<=0||!n||n<=0)return;let o=u.current,s=o.getContext(`2d`),l=Zr(e,n,a,4,i);c(Qr(l));let d=l[0].length,f=l.length;o.width=d,o.height=f;let p=s.createImageData(d,f),m=p.data,h=[400,600,900];for(let e=0;e<f;e++)for(let t=0;t<d;t++){let n=l[e][t],r=(e*d+t)*4,i,a,o,s;if(n<200){let e=n/200;i=30+50*e,a=30+50*e,o=30+50*e,s=180}else if(n<400){let e=(n-200)/200;i=50*e,a=50*e,o=150+105*e,s=180}else if(n<600){let e=(n-400)/200;i=50*(1-e),a=150+105*e,o=50*(1-e),s=180}else if(n<900){let e=(n-600)/300;i=200+55*e,a=200+55*(1-e*.5),o=0,s=190}else if(n<1200){let e=(n-900)/300;i=255,a=100*(1-e),o=0,s=200}else i=255,a=255,o=255,s=220;let c=!1;if(t<d-1){let r=l[e][t+1];for(let e of h)(n<e&&r>=e||n>=e&&r<e)&&(c=!0)}if(!c&&e<f-1){let r=l[e+1][t];for(let e of h)(n<e&&r>=e||n>=e&&r<e)&&(c=!0)}c&&(i=255,a=255,o=255,s=255),m[r]=i,m[r+1]=a,m[r+2]=o,m[r+3]=s}s.putImageData(p,0,0)},[r,a,t]);let g=(e,t,n,r)=>{e.preventDefault(),e.stopPropagation();let i=l.current.getBoundingClientRect();f({instanceId:t,startX:e.clientX,startY:e.clientY,initialX:n,initialY:r,rect:i}),e.target.setPointerCapture(e.pointerId)},_=e=>{if(!d)return;let t=(e.clientX-d.startX)/d.rect.width,n=(e.clientY-d.startY)/d.rect.height,r=Math.max(0,Math.min(1,d.initialX+t)),i=Math.max(0,Math.min(1,d.initialY+n));o(e=>e.map(e=>e.instanceId===d.instanceId?{...e,positions:[{...e.positions[0],x:r,y:i}]}:e))},v=e=>{d&&(e.target.releasePointerCapture(e.pointerId),f(null))},y=(e,t)=>{e.preventDefault(),e.stopPropagation(),o(e=>e.map(e=>{if(e.instanceId===t){let t=e.positions[0].rotation||0;return{...e,positions:[{...e.positions[0],rotation:t===0?90:0}]}}return e}))},x=(e,t)=>{if(t===``){i(t=>({...t,[e]:``}));return}let n=parseFloat(t);isNaN(n)||i(t=>({...t,[e]:n}))};return(0,P.jsxs)(`div`,{className:`ppfd-tool-container`,children:[(0,P.jsx)(Br,{}),(0,P.jsxs)(`div`,{className:`tool-main`,children:[(0,P.jsxs)(`div`,{className:`tool-header`,children:[(0,P.jsx)(`h1`,{children:e(`ppfdToolTitle`)}),(0,P.jsx)(`p`,{children:e(`ppfdToolSubtitle`)})]}),(0,P.jsxs)(`div`,{className:`tool-workspace`,children:[(0,P.jsxs)(`div`,{className:`controls-panel glass-panel`,children:[(0,P.jsxs)(`div`,{className:`control-group`,children:[(0,P.jsx)(`h3`,{children:e(`ppfdToolUnitToggle`)}),(0,P.jsxs)(`div`,{className:`unit-toggle`,children:[(0,P.jsx)(`button`,{className:t===`ft`?`active`:``,onClick:()=>p(`ft`),children:`FT`}),(0,P.jsx)(`button`,{className:t===`cm`?`active`:``,onClick:()=>p(`cm`),children:`CM`})]})]}),(0,P.jsxs)(`div`,{className:`control-group`,children:[(0,P.jsxs)(`h3`,{children:[e(`ppfdToolDimensions`),` (`,t,`)`]}),(0,P.jsxs)(`div`,{className:`input-row`,children:[(0,P.jsxs)(`div`,{className:`input-wrap`,children:[(0,P.jsx)(`label`,{children:e(`width`)}),(0,P.jsx)(`input`,{type:`number`,value:r.width,onChange:e=>x(`width`,e.target.value),min:`1`})]}),(0,P.jsxs)(`div`,{className:`input-wrap`,children:[(0,P.jsx)(`label`,{children:e(`depth`)}),(0,P.jsx)(`input`,{type:`number`,value:r.depth,onChange:e=>x(`depth`,e.target.value),min:`1`})]})]})]}),(0,P.jsxs)(`div`,{className:`control-group`,children:[(0,P.jsxs)(`h3`,{children:[e(`ppfdToolHeight`),` (`,t,`)`]}),(0,P.jsxs)(`div`,{className:`slider-wrap`,children:[(0,P.jsx)(`input`,{type:`range`,min:t===`cm`?15:.5,max:t===`cm`?150:5,step:t===`cm`?5:.1,value:r.height||0,onChange:e=>x(`height`,e.target.value)}),(0,P.jsxs)(`span`,{children:[r.height,` `,t]})]})]}),(0,P.jsxs)(`div`,{className:`control-group`,children:[(0,P.jsx)(`h3`,{children:e(`ppfdToolAddLight`)}),(0,P.jsx)(`div`,{className:`light-list`,children:zi.map(e=>(0,P.jsxs)(`button`,{className:`light-btn`,onClick:()=>m(e),children:[(0,P.jsx)(`span`,{className:`light-icon`,children:`💡`}),(0,P.jsxs)(`div`,{className:`light-info`,children:[(0,P.jsx)(`span`,{className:`light-name`,children:e.name}),(0,P.jsxs)(`span`,{className:`light-specs`,children:[e.maxPPFD,` PPFD`]})]}),(0,P.jsx)(`span`,{className:`add-icon`,children:`+`})]},e.id))})]})]}),(0,P.jsxs)(`div`,{className:`canvas-area`,children:[(0,P.jsxs)(`div`,{className:`metrics-bar glass-panel`,children:[(0,P.jsxs)(`div`,{className:`metric`,children:[(0,P.jsx)(`span`,{className:`metric-label`,children:e(`ppfdToolAvg`)}),(0,P.jsx)(`span`,{className:`metric-value`,children:s.average})]}),(0,P.jsxs)(`div`,{className:`metric`,children:[(0,P.jsx)(`span`,{className:`metric-label`,children:e(`ppfdToolMin`)}),(0,P.jsx)(`span`,{className:`metric-value`,children:s.min})]}),(0,P.jsxs)(`div`,{className:`metric`,children:[(0,P.jsx)(`span`,{className:`metric-label`,children:e(`ppfdToolMax`)}),(0,P.jsx)(`span`,{className:`metric-value`,children:s.max})]}),(0,P.jsxs)(`div`,{className:`metric`,children:[(0,P.jsx)(`span`,{className:`metric-label`,children:e(`ppfdToolUni`)}),(0,P.jsx)(`span`,{className:`metric-value`,children:s.uniformity})]})]}),(0,P.jsxs)(`div`,{className:`canvas-wrapper`,ref:l,style:{aspectRatio:`${(r.width||1)/(r.depth||1)}`},onPointerMove:_,onPointerUp:v,onPointerLeave:v,children:[(0,P.jsx)(`canvas`,{ref:u,className:`heatmap-canvas`}),(0,P.jsx)(`div`,{className:`grid-overlay`}),a.map(e=>{let n=e.positions[0],i=t===`cm`?e.physicalWidth*30.48:e.physicalWidth,a=t===`cm`?e.physicalDepth*30.48:e.physicalDepth,o=i/(r.width||1)*100,s=a/(r.depth||1)*100;return(0,P.jsx)(`div`,{className:`light-element`,style:{left:`${n.x*100}%`,top:`${n.y*100}%`,width:`${o}%`,height:`${s}%`,transform:`translate(-50%, -50%) rotate(${n.rotation}deg)`},onPointerDown:t=>g(t,e.instanceId,n.x,n.y),onDoubleClick:t=>y(t,e.instanceId),children:(0,P.jsx)(`div`,{className:`light-body`,children:(0,P.jsx)(`span`,{className:`remove-btn`,onClick:t=>{t.stopPropagation(),h(e.instanceId)},children:`×`})})},e.instanceId)})]}),(0,P.jsx)(`p`,{className:`instructions`,children:e(`ppfdToolInstructions`)}),(0,P.jsxs)(`div`,{className:`legend glass-panel`,children:[(0,P.jsxs)(`div`,{className:`legend-item`,children:[(0,P.jsx)(`span`,{className:`dot`,style:{background:`#333`}}),` `,e(`ppfdToolLegendLow`)]}),(0,P.jsxs)(`div`,{className:`legend-item`,children:[(0,P.jsx)(`span`,{className:`dot`,style:{background:`blue`}}),` `,e(`ppfdToolLegendSeedling`)]}),(0,P.jsxs)(`div`,{className:`legend-item`,children:[(0,P.jsx)(`span`,{className:`dot`,style:{background:`green`}}),` `,e(`ppfdToolLegendVeg`)]}),(0,P.jsxs)(`div`,{className:`legend-item`,children:[(0,P.jsx)(`span`,{className:`dot`,style:{background:`orange`}}),` `,e(`ppfdToolLegendFlower`)]}),(0,P.jsxs)(`div`,{className:`legend-item`,children:[(0,P.jsx)(`span`,{className:`dot`,style:{background:`red`}}),` `,e(`ppfdToolLegendHigh`)]}),(0,P.jsxs)(`div`,{className:`legend-item`,children:[(0,P.jsx)(`span`,{className:`dot`,style:{background:`white`,border:`1px solid #555`}}),` `,e(`ppfdToolLegendExtreme`)]})]})]})]}),(0,P.jsx)(Ri,{})]}),(0,P.jsx)(zr,{}),(0,P.jsx)(`style`,{children:`
                .ppfd-tool-container {
                    min-height: 100vh;
                    background: #0a0a0a;
                    color: white;
      ...
      `})]})}function Hi(){return(0,P.jsx)(Nr,{children:(0,P.jsx)(Ir,{children:(0,P.jsxs)(wr,{children:[(0,P.jsxs)(Re,{children:[(0,P.jsx)(`title`,{children:`GroWizard`}),(0,P.jsx)(`meta`,{name:`description`,content:`Plan and optimize your perfect grow tent setup with advanced PPFD lighting simulation`})]}),(0,P.jsx)($n,{children:(0,P.jsxs)(gn,{children:[(0,P.jsx)(mn,{path:`/`,element:(0,P.jsx)(Vr,{})}),(0,P.jsx)(mn,{path:`/onboarding`,element:(0,P.jsx)(Hr,{})}),(0,P.jsx)(mn,{path:`/builder`,element:(0,P.jsx)(ki,{})}),(0,P.jsx)(mn,{path:`/grow-tent-setup-builder`,element:(0,P.jsx)(ki,{})}),(0,P.jsx)(mn,{path:`/buyume-cadiri-kurulum-olusturucu`,element:(0,P.jsx)(ki,{})}),(0,P.jsx)(mn,{path:`/blog`,element:(0,P.jsx)(Ai,{})}),(0,P.jsx)(mn,{path:`/blog/:slug`,element:(0,P.jsx)(Ni,{})}),(0,P.jsx)(mn,{path:`/tools`,element:(0,P.jsx)(Pi,{})}),(0,P.jsx)(mn,{path:`/tools/cost-calculator`,element:(0,P.jsx)(Fi,{})}),(0,P.jsx)(mn,{path:`/tools/unit-converter`,element:(0,P.jsx)(Ii,{})}),(0,P.jsx)(mn,{path:`/tools/co2-calculator`,element:(0,P.jsx)(Li,{})}),(0,P.jsx)(mn,{path:`/tools/ppfd-heatmap`,element:(0,P.jsx)(Bi,{})}),(0,P.jsx)(mn,{path:`*`,element:(0,P.jsx)(Vi,{})})]})})]})})})}var Ui=Hi;function Wi(){try{return}catch(e){console.warn(`Analytics init failed:`,e)}}var Gi=({updateSW:e})=>{let[t,n]=(0,b.useState)(!1),{language:r}=F(),i={en:{title:`🎉 New Update Available!`,message:`A new version of GroWizard is ready. Update now for the latest features and improvements.`,update:`Update Now`,later:`Later`},tr:{title:`🎉 Yeni Güncelleme Mevcut!`,message:`GroWizard'ın yeni bir versiyonu hazır. En son özellikler ve iyileştirmeler için şimdi güncelleyin.`,update:`Şimdi Güncelle`,later:`Sonra`}}[r];(0,b.useEffect)(()=>{n(!0)},[]);let a=()=>{n(!1),e(!0)},o=()=>{n(!1)};return t?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`div`,{className:`update-prompt-overlay`,onClick:o}),(0,P.jsxs)(`div`,{className:`update-prompt`,children:[(0,P.jsx)(`div`,{className:`update-icon`,children:`🚀`}),(0,P.jsx)(`h3`,{children:i.title}),(0,P.jsx)(`p`,{children:i.message}),(0,P.jsxs)(`div`,{className:`update-actions`,children:[(0,P.jsx)(`button`,{onClick:a,className:`btn-update`,children:i.update}),(0,P.jsx)(`button`,{onClick:o,className:`btn-later`,children:i.later})]})]}),(0,P.jsx)(`style`,{children:`
      ...
      `})]}):null},Ki=`true`,qi=`false`,Ji=Ki===`true`,Yi=qi===`true`;function Xi(e={}){let{immediate:t=!1,onNeedRefresh:n,onOfflineReady:r,onRegistered:i,onRegisteredSW:a,onRegisterError:o}=e,s,c,l,u=async(e=!0)=>{await c,Ji||l?.()};async function d(){if(`serviceWorker`in navigator){if(s=await He(async()=>{let{Workbox:e}=await import(`./workbox-window.prod.es5-DAxhes2W.js`);return{Workbox:e}},[]).then(({Workbox:e})=>new e(`/sw.js`,{scope:`/`,type:`classic`})).catch(e=>{o?.(e)}),!s)return;if(l=()=>{s?.messageSkipWaiting()},!Yi)if(Ji)s.addEventListener(`activated`,e=>{(e.isUpdate||e.isExternal)&&window.location.reload()}),s.addEventListener(`installed`,e=>{e.isUpdate||r?.()});else{let e=!1,t=()=>{e=!0,s?.addEventListener(`controlling`,e=>{e.isUpdate&&window.location.reload()}),n?.()};s.addEventListener(`installed`,n=>{n.isUpdate===void 0?n.isExternal===void 0?!e&&r?.():n.isExternal?t():!e&&r?.():n.isUpdate||r?.()}),s.addEventListener(`waiting`,t)}s.register({immediate:t}).then(e=>{a?a(`/sw.js`,e):i?.(e)}).catch(e=>{o?.(e)})}}return c=d(),u}Wi();var Zi=null,L=Xi({onNeedRefresh(){Zi&&Zi()},onOfflineReady(){console.log(`✅ App ready to work offline`)},onRegistered(e){console.log(`✅ Service Worker registered`),e&&setInterval(()=>{e.update()},3600*1e3)},onRegisterError(e){console.error(`❌ Service Worker registration error:`,e)}});function R(){let[e,t]=(0,b.useState)(!1);return Zi=()=>t(!0),(0,P.jsx)(b.StrictMode,{children:(0,P.jsxs)(Ae,{children:[(0,P.jsx)(Ui,{}),e&&(0,P.jsx)(Gi,{updateSW:L})]})})}(0,y.createRoot)(document.getElementById(`root`)).render((0,P.jsx)(R,{}));